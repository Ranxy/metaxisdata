...
| 批 1 · 契约与文档一致性 | 不变：`C1`、`C4`、`C5`、`C6`、`C7`、`C9`、`C10`、`C13`、`D14`、`D15`、`D16`、`D21`、`B14`；追加两条纯文档动作：删除反射死分支（F2）、写明单租户与 XOR 威胁模型（F1/F3） |
| 批 2 · 正确性 | 不变：`B2`–`B12`，另加 `B16`（eventTime UTC 兜底，F10） |
| 批 3 · 安全收尾 | 收敛为 `A4`、`A5`、`A6`、`A8`、`A9`；`A1`/`A7` 已由决策关闭（A7 只剩删死分支 + 文档） |
