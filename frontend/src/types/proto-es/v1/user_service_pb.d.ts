...
/**
 * @generated from message metaxisdata.v1.GetUserRequest
 */
export declare type GetUserRequest = Message<"metaxisdata.v1.GetUserRequest"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.BatchGetUsersRequest
 */
export declare type BatchGetUsersRequest = Message<"metaxisdata.v1.BatchGetUsersRequest"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.BatchGetUsersResponse
 */
export declare type BatchGetUsersResponse = Message<"metaxisdata.v1.BatchGetUsersResponse"> & {
  /**
   * The users from the specified request.
   *
   * @generated from field: repeated metaxisdata.v1.User users = 1;
   */
  users: User[];
};
...
/**
 * @generated from message metaxisdata.v1.ListUsersRequest
 */
export declare type ListUsersRequest = Message<"metaxisdata.v1.ListUsersRequest"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.ListUsersResponse
 */
export declare type ListUsersResponse = Message<"metaxisdata.v1.ListUsersResponse"> & {
  /**
   * The users from the specified request.
   *
   * @generated from field: repeated metaxisdata.v1.User users = 1;
...
/**
 * @generated from message metaxisdata.v1.CreateUserRequest
 */
export declare type CreateUserRequest = Message<"metaxisdata.v1.CreateUserRequest"> & {
  /**
   * The user to create.
   *
   * @generated from field: metaxisdata.v1.User user = 1;
   */
  user?: User;
};
...
/**
 * @generated from message metaxisdata.v1.UpdateUserRequest
 */
export declare type UpdateUserRequest = Message<"metaxisdata.v1.UpdateUserRequest"> & {
  /**
   * The user to update.
   *
...
/**
 * @generated from message metaxisdata.v1.DeleteUserRequest
 */
export declare type DeleteUserRequest = Message<"metaxisdata.v1.DeleteUserRequest"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.UndeleteUserRequest
 */
export declare type UndeleteUserRequest = Message<"metaxisdata.v1.UndeleteUserRequest"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.User
 */
export declare type User = Message<"metaxisdata.v1.User"> & {
  /**
  ...
  /**
   * @generated from field: metaxisdata.v1.State state = 2;
   */
  state: State;
  ...
  /**
   * @generated from field: metaxisdata.v1.UserType user_type = 5;
   */
  userType: UserType;
  ...
  /**
   * @generated from field: metaxisdata.v1.UserProfile profile = 13;
   */
  profile?: UserProfile;
...
/**
 * @generated from message metaxisdata.v1.UserProfile
 */
export declare type UserProfile = Message<"metaxisdata.v1.UserProfile"> & {
  /**
...
export declare const UserService: GenService<{
   ...
   *
   * @generated from rpc metaxisdata.v1.UserService.GetCurrentUser
   */
  getCurrentUser: {
    methodKind: "unary";
   ...
   * Create a user.
   *
   * @generated from rpc metaxisdata.v1.UserService.CreateUser
   */
  createUser: {
    methodKind: "unary";
   ...
   *
   * @generated from rpc metaxisdata.v1.UserService.UpdateUser
   */
  updateUser: {
    methodKind: "unary";
   ...
   *
   * @generated from rpc metaxisdata.v1.UserService.DeleteUser
   */
  deleteUser: {
    methodKind: "unary";
   ...
   *
   * @generated from rpc metaxisdata.v1.UserService.UndeleteUser
   */
  undeleteUser: {
    methodKind: "unary";
