...
/**
 * @generated from message metaxisdata.v1.GetInstanceRequest
 */
export declare type GetInstanceRequest = Message<"metaxisdata.v1.GetInstanceRequest"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.ListInstancesRequest
 */
export declare type ListInstancesRequest = Message<"metaxisdata.v1.ListInstancesRequest"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.ListInstancesResponse
 */
export declare type ListInstancesResponse = Message<"metaxisdata.v1.ListInstancesResponse"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.CreateInstanceRequest
 */
export declare type CreateInstanceRequest = Message<"metaxisdata.v1.CreateInstanceRequest"> & {
  /**
   * The instance to create.
   *
   * @generated from field: metaxisdata.v1.Instance instance = 1;
   */
  instance?: Instance;
...
/**
 * @generated from message metaxisdata.v1.UpdateInstanceRequest
 */
export declare type UpdateInstanceRequest = Message<"metaxisdata.v1.UpdateInstanceRequest"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.DeleteInstanceRequest
 */
export declare type DeleteInstanceRequest = Message<"metaxisdata.v1.DeleteInstanceRequest"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.UndeleteInstanceRequest
 */
export declare type UndeleteInstanceRequest = Message<"metaxisdata.v1.UndeleteInstanceRequest"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.SyncInstanceRequest
 */
export declare type SyncInstanceRequest = Message<"metaxisdata.v1.SyncInstanceRequest"> & {
  /**
 ...
 */
export declare type SyncInstanceResponse = Message<"metaxisdata.v1.SyncInstanceResponse"> & {
  /**
   * All database name list in the instance.
   *
   * @generated from field: repeated string databases = 1;
...
/**
 * @generated from message metaxisdata.v1.BatchSyncInstancesRequest
 */
export declare type BatchSyncInstancesRequest = Message<"metaxisdata.v1.BatchSyncInstancesRequest"> & {
  /**
   * The request message specifying the instances to sync.
   * A maximum of 1000 instances can be synced in a batch.
   *
   * @generated from field: repeated metaxisdata.v1.SyncInstanceRequest requests = 1;
   */
...
/**
 * @generated from message metaxisdata.v1.BatchUpdateInstancesResponse
 */
 ...
 */
export declare type Instance = Message<"metaxisdata.v1.Instance"> & {
  /**
   * The name of the instance.
   * Format: instances/{instance}
   *
  ...
  /**
   * @generated from field: metaxisdata.v1.Engine engine = 5;
   */
  engine: Engine;
...
/**
 * @generated from message metaxisdata.v1.DataSourceExternalSecret
 */
export declare type DataSourceExternalSecret = Message<"metaxisdata.v1.DataSourceExternalSecret"> & {
  /**
   * @generated from field: metaxisdata.v1.DataSourceExternalSecret.SecretType secret_type = 1;
   */
  ...
  /**
   * @generated from field: metaxisdata.v1.DataSourceExternalSecret.AuthType auth_type = 3;
   */
  authType: DataSourceExternalSecret_AuthType;

  /**
   * @generated from oneof metaxisdata.v1.DataSourceExternalSecret.auth_option
   */
  authOption: {
    /**
     * @generated from field: metaxisdata.v1.DataSourceExternalSecret.AppRoleAuthOption app_role = 4;
     */
...
/**
 * @generated from message metaxisdata.v1.DataSourceExternalSecret.AppRoleAuthOption
 */
export declare type DataSourceExternalSecret_AppRoleAuthOption = Message<"metaxisdata.v1.DataSourceExternalSecret.AppRoleAuthOption"> & {
  /**
  ...
  /**
   * @generated from field: metaxisdata.v1.DataSourceExternalSecret.AppRoleAuthOption.SecretType type = 3;
   */
...
/**
 * @generated from message metaxisdata.v1.DataSource
 */
export declare type DataSource = Message<"metaxisdata.v1.DataSource"> & {
  ...
  /**
   * @generated from field: metaxisdata.v1.DataSourceExternalSecret external_secret = 21;
   */
  externalSecret?: DataSourceExternalSecret;

  /**
   * @generated from field: metaxisdata.v1.DataSource.AuthenticationType authentication_type = 22;
   */
  authenticationType: DataSource_AuthenticationType;

  /**
   * @generated from oneof metaxisdata.v1.DataSource.iam_extension
   */
  iamExtension: {
    /**
     * @generated from field: metaxisdata.v1.DataSource.AzureCredential azure_credential = 23;
     */
    value: DataSource_AzureCredential;
    case: "azureCredential";
  } | {
    /**
     * @generated from field: metaxisdata.v1.DataSource.AWSCredential aws_credential = 37;
     */
    value: DataSource_AWSCredential;
    case: "awsCredential";
  } | {
    /**
     * @generated from field: metaxisdata.v1.DataSource.GCPCredential gcp_credential = 38;
     */
  ...
  /**
   * @generated from field: metaxisdata.v1.SASLConfig sasl_config = 24;
   */
   ...
   *
   * @generated from field: repeated metaxisdata.v1.DataSource.Address additional_addresses = 26;
   */
  ...
  /**
   * @generated from field: metaxisdata.v1.DataSource.RedisType redis_type = 34;
   */
...
/**
 * @generated from message metaxisdata.v1.DataSource.AzureCredential
 */
export declare type DataSource_AzureCredential = Message<"metaxisdata.v1.DataSource.AzureCredential"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.DataSource.AWSCredential
 */
export declare type DataSource_AWSCredential = Message<"metaxisdata.v1.DataSource.AWSCredential"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.DataSource.GCPCredential
 */
export declare type DataSource_GCPCredential = Message<"metaxisdata.v1.DataSource.GCPCredential"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.DataSource.Address
 */
export declare type DataSource_Address = Message<"metaxisdata.v1.DataSource.Address"> & {
  /**
...
/**
 * @generated from message metaxisdata.v1.InstanceResource
 */
export declare type InstanceResource = Message<"metaxisdata.v1.InstanceResource"> & {
  /**
  ...
  /**
   * @generated from field: metaxisdata.v1.Engine engine = 2;
   */
  engine: Engine;
  ...
  /**
   * @generated from field: repeated metaxisdata.v1.DataSource data_sources = 4;
   */
  dataSources: DataSource[];
...
/**
 * @generated from message metaxisdata.v1.SASLConfig
 */
export declare type SASLConfig = Message<"metaxisdata.v1.SASLConfig"> & {
  /**
   * @generated from oneof metaxisdata.v1.SASLConfig.mechanism
   */
  mechanism: {
    /**
     * @generated from field: metaxisdata.v1.KerberosConfig krb_config = 1;
     */
...
/**
 * @generated from message metaxisdata.v1.KerberosConfig
 */
export declare type KerberosConfig = Message<"metaxisdata.v1.KerberosConfig"> & {
  /**
...
export declare const InstanceService: GenService<{
  /**
   * @generated from rpc metaxisdata.v1.InstanceService.GetInstance
   */
  getInstance: {
    methodKind: "unary";
  ...
  /**
   * @generated from rpc metaxisdata.v1.InstanceService.ListInstances
   */
  listInstances: {
    methodKind: "unary";
  ...
  /**
   * @generated from rpc metaxisdata.v1.InstanceService.CreateInstance
   */
  createInstance: {
    methodKind: "unary";
  ...
  /**
   * @generated from rpc metaxisdata.v1.InstanceService.UpdateInstance
   */
  updateInstance: {
    methodKind: "unary";
  ...
  /**
   * @generated from rpc metaxisdata.v1.InstanceService.DeleteInstance
   */
  deleteInstance: {
    methodKind: "unary";
  ...
  /**
   * @generated from rpc metaxisdata.v1.InstanceService.UndeleteInstance
   */
  undeleteInstance: {
    methodKind: "unary";
  ...
  /**
   * @generated from rpc metaxisdata.v1.InstanceService.SyncInstance
   */
  syncInstance: {
    methodKind: "unary";
  ...
  /**
   * @generated from rpc metaxisdata.v1.InstanceService.BatchUpdateInstances
   */
