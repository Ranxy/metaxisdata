...
// built on github.com/bytebase/omni's MariaDB parser and typed AST. The traversal
// is identical today; the shared golden corpus keeps the dialects behaviorally in
// sync. Add MariaDB-specific handling here as this dialect's AST diverges.
package mariadb
