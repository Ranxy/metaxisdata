...
type MetadataHistoryOperation int32

const (
	MetadataHistoryOperation_METADATA_HISTORY_OPERATION_UNSPECIFIED MetadataHistoryOperation = 0
	MetadataHistoryOperation_METADATA_HISTORY_OPERATION_CREATED     MetadataHistoryOperation = 1
	MetadataHistoryOperation_METADATA_HISTORY_OPERATION_UPDATED     MetadataHistoryOperation = 2
	MetadataHistoryOperation_METADATA_HISTORY_OPERATION_DELETED     MetadataHistoryOperation = 3
)

// Enum value maps for MetadataHistoryOperation.
var (
	MetadataHistoryOperation_name = map[int32]string{
		0: "METADATA_HISTORY_OPERATION_UNSPECIFIED",
		1: "METADATA_HISTORY_OPERATION_CREATED",
		2: "METADATA_HISTORY_OPERATION_UPDATED",
		3: "METADATA_HISTORY_OPERATION_DELETED",
	}
	MetadataHistoryOperation_value = map[string]int32{
...
func (x MetadataHistoryOperation) Enum() *MetadataHistoryOperation {
	p := new(MetadataHistoryOperation)
	*p = x
	return p
}

func (x MetadataHistoryOperation) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MetadataHistoryOperation) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_database_service_proto_enumTypes[0].Descriptor()
}

func (MetadataHistoryOperation) Type() protoreflect.EnumType {
	return &file_v1_database_service_proto_enumTypes[0]
}

func (x MetadataHistoryOperation) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MetadataHistoryOperation.Descriptor instead.
func (MetadataHistoryOperation) EnumDescriptor() ([]byte, []int) {
	return file_v1_database_service_proto_rawDescGZIP(), []int{0}
}

type MetadataHistorySection int32

const (
	MetadataHistorySection_METADATA_HISTORY_SECTION_UNSPECIFIED      MetadataHistorySection = 0
	MetadataHistorySection_METADATA_HISTORY_SECTION_SELF             MetadataHistorySection = 1
	MetadataHistorySection_METADATA_HISTORY_SECTION_COLUMN           MetadataHistorySection = 2
	MetadataHistorySection_METADATA_HISTORY_SECTION_INDEX            MetadataHistorySection = 3
	MetadataHistorySection_METADATA_HISTORY_SECTION_FOREIGN_KEY      MetadataHistorySection = 4
	MetadataHistorySection_METADATA_HISTORY_SECTION_CHECK_CONSTRAINT MetadataHistorySection = 5
	MetadataHistorySection_METADATA_HISTORY_SECTION_PARTITION        MetadataHistorySection = 6
	MetadataHistorySection_METADATA_HISTORY_SECTION_TRIGGER          MetadataHistorySection = 7
	MetadataHistorySection_METADATA_HISTORY_SECTION_RULE             MetadataHistorySection = 8
	MetadataHistorySection_METADATA_HISTORY_SECTION_TAG              MetadataHistorySection = 9
	MetadataHistorySection_METADATA_HISTORY_SECTION_ATTRIBUTE        MetadataHistorySection = 10
)

// Enum value maps for MetadataHistorySection.
var (
	MetadataHistorySection_name = map[int32]string{
		0:  "METADATA_HISTORY_SECTION_UNSPECIFIED",
		1:  "METADATA_HISTORY_SECTION_SELF",
		2:  "METADATA_HISTORY_SECTION_COLUMN",
		3:  "METADATA_HISTORY_SECTION_INDEX",
		4:  "METADATA_HISTORY_SECTION_FOREIGN_KEY",
		5:  "METADATA_HISTORY_SECTION_CHECK_CONSTRAINT",
		6:  "METADATA_HISTORY_SECTION_PARTITION",
		7:  "METADATA_HISTORY_SECTION_TRIGGER",
		8:  "METADATA_HISTORY_SECTION_RULE",
		9:  "METADATA_HISTORY_SECTION_TAG",
		10: "METADATA_HISTORY_SECTION_ATTRIBUTE",
	}
	MetadataHistorySection_value = map[string]int32{
...
func (x MetadataHistorySection) Enum() *MetadataHistorySection {
	p := new(MetadataHistorySection)
	*p = x
	return p
}

func (x MetadataHistorySection) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MetadataHistorySection) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_database_service_proto_enumTypes[1].Descriptor()
}

func (MetadataHistorySection) Type() protoreflect.EnumType {
	return &file_v1_database_service_proto_enumTypes[1]
}

func (x MetadataHistorySection) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MetadataHistorySection.Descriptor instead.
func (MetadataHistorySection) EnumDescriptor() ([]byte, []int) {
...
func (TablePartitionMetadata_Type) EnumDescriptor() ([]byte, []int) {
	return file_v1_database_service_proto_rawDescGZIP(), []int{48, 0}
}
...
func (ColumnMetadata_IdentityGeneration) EnumDescriptor() ([]byte, []int) {
	return file_v1_database_service_proto_rawDescGZIP(), []int{49, 0}
}
...
func (GenerationMetadata_Type) EnumDescriptor() ([]byte, []int) {
	return file_v1_database_service_proto_rawDescGZIP(), []int{50, 0}
}
...
type ListMetadataHistoryRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Guid          string                 `protobuf:"bytes,1,opt,name=guid,proto3" json:"guid,omitempty"`
	MetaType      MetaType               `protobuf:"varint,2,opt,name=meta_type,json=metaType,proto3,enum=metaxisdata.v1.MetaType" json:"meta_type,omitempty"`
...
func (x *ListMetadataHistoryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ListMetadataHistoryRequest) GetMetaType() MetaType {
	if x != nil {
		return x.MetaType
	}
	return MetaType_UNSPECIFIED
...
func (x *ListMetadataHistoryRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *ListMetadataHistoryRequest) GetPageToken() string {
	if x != nil {
		return x.PageToken
	}
	return ""
...
type ListMetadataHistoryResponse struct {
	state         protoimpl.MessageState          `protogen:"open.v1"`
	Entries       []*MetadataHistoryTimelineEntry `protobuf:"bytes,1,rep,name=entries,proto3" json:"entries,omitempty"`
	NextPageToken string                          `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListMetadataHistoryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ListMetadataHistoryResponse) GetNextPageToken() string {
	if x != nil {
		return x.NextPageToken
	}
	return ""
...
type GetMetadataHistoryEventRequest struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Guid          string                   `protobuf:"bytes,1,opt,name=guid,proto3" json:"guid,omitempty"`
	MetaType      MetaType                 `protobuf:"varint,2,opt,name=meta_type,json=metaType,proto3,enum=metaxisdata.v1.MetaType" json:"meta_type,omitempty"`
	EventTime     *timestamppb.Timestamp   `protobuf:"bytes,3,opt,name=event_time,json=eventTime,proto3" json:"event_time,omitempty"`
	Operation     MetadataHistoryOperation `protobuf:"varint,4,opt,name=operation,proto3,enum=metaxisdata.v1.MetadataHistoryOperation" json:"operation,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetMetadataHistoryEventRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetMetadataHistoryEventRequest) GetMetaType() MetaType {
	if x != nil {
		return x.MetaType
	}
	return MetaType_UNSPECIFIED
...
func (x *GetMetadataHistoryEventRequest) GetEventTime() *timestamppb.Timestamp {
	if x != nil {
		return x.EventTime
	}
	return nil
...
func (x *GetMetadataHistoryEventRequest) GetOperation() MetadataHistoryOperation {
	if x != nil {
		return x.Operation
	}
	return MetadataHistoryOperation_METADATA_HISTORY_OPERATION_UNSPECIFIED
}

type MetadataHistorySectionChangeCount struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Section       MetadataHistorySection `protobuf:"varint,1,opt,name=section,proto3,enum=metaxisdata.v1.MetadataHistorySection" json:"section,omitempty"`
...
func (x *MetadataHistorySectionChangeCount) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MetadataHistorySectionChangeCount) GetSection() MetadataHistorySection {
	...
	return MetadataHistorySection_METADATA_HISTORY_SECTION_UNSPECIFIED
}

func (x *MetadataHistorySectionChangeCount) GetAdded() int32 {
	if x != nil {
		return x.Added
	}
	return 0
...
func (x *MetadataHistorySectionChangeCount) GetUpdated() int32 {
	if x != nil {
		return x.Updated
	}
	return 0
...
func (x *MetadataHistorySectionChangeCount) GetRemoved() int32 {
	if x != nil {
		return x.Removed
	}
	return 0
...
type MetadataHistoryTimelineEntry struct {
	state          protoimpl.MessageState               `protogen:"open.v1"`
	Guid           string                               `protobuf:"bytes,1,opt,name=guid,proto3" json:"guid,omitempty"`
	MetaType       MetaType                             `protobuf:"varint,2,opt,name=meta_type,json=metaType,proto3,enum=metaxisdata.v1.MetaType" json:"meta_type,omitempty"`
	EventTime      *timestamppb.Timestamp               `protobuf:"bytes,3,opt,name=event_time,json=eventTime,proto3" json:"event_time,omitempty"`
	...
	Operation      MetadataHistoryOperation             `protobuf:"varint,6,opt,name=operation,proto3,enum=metaxisdata.v1.MetadataHistoryOperation" json:"operation,omitempty"`
	Summary        string                               `protobuf:"bytes,7,opt,name=summary,proto3" json:"summary,omitempty"`
	SectionChanges []*MetadataHistorySectionChangeCount `protobuf:"bytes,8,rep,name=section_changes,json=sectionChanges,proto3" json:"section_changes,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *MetadataHistoryTimelineEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MetadataHistoryTimelineEntry) GetMetaType() MetaType {
	if x != nil {
		return x.MetaType
	}
	return MetaType_UNSPECIFIED
...
func (x *MetadataHistoryTimelineEntry) GetEventTime() *timestamppb.Timestamp {
	if x != nil {
		return x.EventTime
	}
	return nil
...
func (x *MetadataHistoryTimelineEntry) GetValidFrom() *timestamppb.Timestamp {
	if x != nil {
		return x.ValidFrom
	}
	return nil
...
func (x *MetadataHistoryTimelineEntry) GetValidTo() *timestamppb.Timestamp {
	if x != nil {
		return x.ValidTo
	}
	return nil
...
func (x *MetadataHistoryTimelineEntry) GetOperation() MetadataHistoryOperation {
	if x != nil {
		return x.Operation
	}
	return MetadataHistoryOperation_METADATA_HISTORY_OPERATION_UNSPECIFIED
...
func (x *MetadataHistoryTimelineEntry) GetSummary() string {
	if x != nil {
		return x.Summary
	}
	return ""
...
func (x *MetadataHistoryTimelineEntry) GetSectionChanges() []*MetadataHistorySectionChangeCount {
	if x != nil {
		return x.SectionChanges
	}
	return nil
}
...
func (x *MetadataFieldChange) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MetadataFieldChange) GetDisplayName() string {
	if x != nil {
...
func (x *MetadataFieldChange) GetBefore() string {
	if x != nil {
		return x.Before
	}
	return ""
...
func (x *MetadataFieldChange) GetAfter() string {
	if x != nil {
		return x.After
	}
	return ""
...
type MetadataHistoryChildSnapshot struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Metadata:
	//
	//	*MetadataHistoryChildSnapshot_ColumnMetadata
	//	*MetadataHistoryChildSnapshot_IndexMetadata
	//	*MetadataHistoryChildSnapshot_ForeignKeyMetadata
	//	*MetadataHistoryChildSnapshot_CheckConstraintMetadata
	//	*MetadataHistoryChildSnapshot_PartitionMetadata
	//	*MetadataHistoryChildSnapshot_TriggerMetadata
	//	*MetadataHistoryChildSnapshot_RuleMetadata
	Metadata      isMetadataHistoryChildSnapshot_Metadata `protobuf_oneof:"metadata"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MetadataHistoryChildSnapshot) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MetadataHistoryChildSnapshot) GetColumnMetadata() *ColumnMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*MetadataHistoryChildSnapshot_ColumnMetadata); ok {
...
func (x *MetadataHistoryChildSnapshot) GetIndexMetadata() *IndexMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*MetadataHistoryChildSnapshot_IndexMetadata); ok {
...
func (x *MetadataHistoryChildSnapshot) GetForeignKeyMetadata() *ForeignKeyMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*MetadataHistoryChildSnapshot_ForeignKeyMetadata); ok {
			return x.ForeignKeyMetadata
		}
	}
	return nil
}

func (x *MetadataHistoryChildSnapshot) GetCheckConstraintMetadata() *CheckConstraintMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*MetadataHistoryChildSnapshot_CheckConstraintMetadata); ok {
			return x.CheckConstraintMetadata
		}
	}
	return nil
}

func (x *MetadataHistoryChildSnapshot) GetPartitionMetadata() *TablePartitionMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*MetadataHistoryChildSnapshot_PartitionMetadata); ok {
...
func (x *MetadataHistoryChildSnapshot) GetTriggerMetadata() *TriggerMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*MetadataHistoryChildSnapshot_TriggerMetadata); ok {
...
func (x *MetadataHistoryChildSnapshot) GetRuleMetadata() *RuleMetadata {
	if x != nil {
		if x, ok := x.Metadata.(*MetadataHistoryChildSnapshot_RuleMetadata); ok {
...
type isMetadataHistoryChildSnapshot_Metadata interface {
	isMetadataHistoryChildSnapshot_Metadata()
}

type MetadataHistoryChildSnapshot_ColumnMetadata struct {
	ColumnMetadata *ColumnMetadata `protobuf:"bytes,1,opt,name=column_metadata,json=columnMetadata,proto3,oneof"`
}

type MetadataHistoryChildSnapshot_IndexMetadata struct {
	IndexMetadata *IndexMetadata `protobuf:"bytes,2,opt,name=index_metadata,json=indexMetadata,proto3,oneof"`
}

type MetadataHistoryChildSnapshot_ForeignKeyMetadata struct {
	ForeignKeyMetadata *ForeignKeyMetadata `protobuf:"bytes,3,opt,name=foreign_key_metadata,json=foreignKeyMetadata,proto3,oneof"`
}

type MetadataHistoryChildSnapshot_CheckConstraintMetadata struct {
	CheckConstraintMetadata *CheckConstraintMetadata `protobuf:"bytes,4,opt,name=check_constraint_metadata,json=checkConstraintMetadata,proto3,oneof"`
}

type MetadataHistoryChildSnapshot_PartitionMetadata struct {
	PartitionMetadata *TablePartitionMetadata `protobuf:"bytes,5,opt,name=partition_metadata,json=partitionMetadata,proto3,oneof"`
}

type MetadataHistoryChildSnapshot_TriggerMetadata struct {
	TriggerMetadata *TriggerMetadata `protobuf:"bytes,6,opt,name=trigger_metadata,json=triggerMetadata,proto3,oneof"`
}

type MetadataHistoryChildSnapshot_RuleMetadata struct {
	RuleMetadata *RuleMetadata `protobuf:"bytes,7,opt,name=rule_metadata,json=ruleMetadata,proto3,oneof"`
}

func (*MetadataHistoryChildSnapshot_ColumnMetadata) isMetadataHistoryChildSnapshot_Metadata() {}

func (*MetadataHistoryChildSnapshot_IndexMetadata) isMetadataHistoryChildSnapshot_Metadata() {}

func (*MetadataHistoryChildSnapshot_ForeignKeyMetadata) isMetadataHistoryChildSnapshot_Metadata() {}

func (*MetadataHistoryChildSnapshot_CheckConstraintMetadata) isMetadataHistoryChildSnapshot_Metadata() {
}

func (*MetadataHistoryChildSnapshot_PartitionMetadata) isMetadataHistoryChildSnapshot_Metadata() {}

func (*MetadataHistoryChildSnapshot_TriggerMetadata) isMetadataHistoryChildSnapshot_Metadata() {}

func (*MetadataHistoryChildSnapshot_RuleMetadata) isMetadataHistoryChildSnapshot_Metadata() {}

type MetadataHistoryChangeItem struct {
	state         protoimpl.MessageState        `protogen:"open.v1"`
	Section       MetadataHistorySection        `protobuf:"varint,1,opt,name=section,proto3,enum=metaxisdata.v1.MetadataHistorySection" json:"section,omitempty"`
	Operation     MetadataHistoryOperation      `protobuf:"varint,2,opt,name=operation,proto3,enum=metaxisdata.v1.MetadataHistoryOperation" json:"operation,omitempty"`
	Key           string                        `protobuf:"bytes,3,opt,name=key,proto3" json:"key,omitempty"`
	DisplayName   string                        `protobuf:"bytes,4,opt,name=display_name,json=displayName,proto3" json:"display_name,omitempty"`
	Summary       string                        `protobuf:"bytes,5,opt,name=summary,proto3" json:"summary,omitempty"`
	FieldChanges  []*MetadataFieldChange        `protobuf:"bytes,6,rep,name=field_changes,json=fieldChanges,proto3" json:"field_changes,omitempty"`
	Before        *MetadataHistoryChildSnapshot `protobuf:"bytes,7,opt,name=before,proto3" json:"before,omitempty"`
	After         *MetadataHistoryChildSnapshot `protobuf:"bytes,8,opt,name=after,proto3" json:"after,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MetadataHistoryChangeItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MetadataHistoryChangeItem) GetOperation() MetadataHistoryOperation {
	if x != nil {
		return x.Operation
	}
	return MetadataHistoryOperation_METADATA_HISTORY_OPERATION_UNSPECIFIED
...
func (x *MetadataHistoryChangeItem) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *MetadataHistoryChangeItem) GetDisplayName() string {
	if x != nil {
		return x.DisplayName
	}
	return ""
...
func (x *MetadataHistoryChangeItem) GetSummary() string {
	if x != nil {
		return x.Summary
	}
	return ""
...
func (x *MetadataHistoryChangeItem) GetFieldChanges() []*MetadataFieldChange {
	if x != nil {
...
func (x *MetadataHistoryChangeItem) GetBefore() *MetadataHistoryChildSnapshot {
	if x != nil {
		return x.Before
	}
	return nil
...
func (x *MetadataHistoryChangeItem) GetAfter() *MetadataHistoryChildSnapshot {
	if x != nil {
		return x.After
	}
	return nil
...
type MetadataHistoryChangeGroup struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Section       MetadataHistorySection       `protobuf:"varint,1,opt,name=section,proto3,enum=metaxisdata.v1.MetadataHistorySection" json:"section,omitempty"`
	Changes       []*MetadataHistoryChangeItem `protobuf:"bytes,2,rep,name=changes,proto3" json:"changes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MetadataHistoryChangeGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MetadataHistoryChangeGroup) GetChanges() []*MetadataHistoryChangeItem {
	if x != nil {
		return x.Changes
	}
	return nil
...
type MetadataHistoryEvent struct {
	state          protoimpl.MessageState        `protogen:"open.v1"`
	Entry          *MetadataHistoryTimelineEntry `protobuf:"bytes,1,opt,name=entry,proto3" json:"entry,omitempty"`
	BeforeMetadata *StoredMetadata               `protobuf:"bytes,2,opt,name=before_metadata,json=beforeMetadata,proto3" json:"before_metadata,omitempty"`
	AfterMetadata  *StoredMetadata               `protobuf:"bytes,3,opt,name=after_metadata,json=afterMetadata,proto3" json:"after_metadata,omitempty"`
	ChangeGroups   []*MetadataHistoryChangeGroup `protobuf:"bytes,4,rep,name=change_groups,json=changeGroups,proto3" json:"change_groups,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *MetadataHistoryEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MetadataHistoryEvent) GetBeforeMetadata() *StoredMetadata {
	if x != nil {
		return x.BeforeMetadata
	}
	return nil
}

func (x *MetadataHistoryEvent) GetAfterMetadata() *StoredMetadata {
	if x != nil {
		return x.AfterMetadata
	}
	return nil
}

func (x *MetadataHistoryEvent) GetChangeGroups() []*MetadataHistoryChangeGroup {
	if x != nil {
		return x.ChangeGroups
	}
	return nil
}
...
func (x *DiffMetadataRequest) GetSourceTime() *timestamppb.Timestamp {
	if x != nil {
		return x.SourceTime
	}
	return nil
...
func (x *DiffMetadataRequest) GetTargetTime() *timestamppb.Timestamp {
	if x != nil {
		return x.TargetTime
	}
	return nil
...
func (x *DiffMetadataResponse) GetDdl() string {
	if x != nil {
		return x.Ddl
	}
	return ""
...
type StorageConfig struct {
	...
	SortInTempdb    string `protobuf:"bytes,8,opt,name=sort_in_tempdb,json=sortInTempdb,proto3" json:"sort_in_tempdb,omitempty"`
	...
	DataCompression string `protobuf:"bytes,14,opt,name=data_compression,json=dataCompression,proto3" json:"data_compression,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_v1_database_service_proto_rawDesc = "" +
	...
	"\toperation\x18\x04 \x01(\x0e2(.metaxisdata.v1.MetadataHistoryOperationB\x03\xe0A\x02R\toperation\"\xaf\x01\n" +
	"!MetadataHistorySectionChangeCount\x12@\n" +
	"\asection\x18\x01 \x01(\x0e2&.metaxisdata.v1.MetadataHistorySectionR\asection\x12\x14\n" +
	"\x05added\x18\x02 \x01(\x05R\x05added\x12\x18\n" +
	"\aupdated\x18\x03 \x01(\x05R\aupdated\x12\x18\n" +
	"\aremoved\x18\x04 \x01(\x05R\aremoved\"\xd4\x03\n" +
	"\x1cMetadataHistoryTimelineEntry\x12\x12\n" +
	"\x04guid\x18\x01 \x01(\tR\x04guid\x125\n" +
	"\tmeta_type\x18\x02 \x01(\x0e2\x18.metaxisdata.v1.MetaTypeR\bmetaType\x129\n" +
	"\n" +
	...
	"\bvalid_to\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\avalidTo\x12F\n" +
	"\toperation\x18\x06 \x01(\x0e2(.metaxisdata.v1.MetadataHistoryOperationR\toperation\x12\x18\n" +
	"\asummary\x18\a \x01(\tR\asummary\x12Z\n" +
	"\x0fsection_changes\x18\b \x03(\v21.metaxisdata.v1.MetadataHistorySectionChangeCountR\x0esectionChanges\"|\n" +
	"\x13MetadataFieldChange\x12\x14\n" +
	"\x05field\x18\x01 \x01(\tR\x05field\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName\x12\x16\n" +
	"\x06before\x18\x03 \x01(\tR\x06before\x12\x14\n" +
	"\x05after\x18\x04 \x01(\tR\x05after\"\xe8\x04\n" +
	"\x1cMetadataHistoryChildSnapshot\x12I\n" +
	"\x0fcolumn_metadata\x18\x01 \x01(\v2\x1e.metaxisdata.v1.ColumnMetadataH\x00R\x0ecolumnMetadata\x12F\n" +
	"\x0eindex_metadata\x18\x02 \x01(\v2\x1d.metaxisdata.v1.IndexMetadataH\x00R\rindexMetadata\x12V\n" +
	"\x14foreign_key_metadata\x18\x03 \x01(\v2\".metaxisdata.v1.ForeignKeyMetadataH\x00R\x12foreignKeyMetadata\x12e\n" +
	"\x19check_constraint_metadata\x18\x04 \x01(\v2'.metaxisdata.v1.CheckConstraintMetadataH\x00R\x17checkConstraintMetadata\x12W\n" +
	"\x12partition_metadata\x18\x05 \x01(\v2&.metaxisdata.v1.TablePartitionMetadataH\x00R\x11partitionMetadata\x12L\n" +
	"\x10trigger_metadata\x18\x06 \x01(\v2\x1f.metaxisdata.v1.TriggerMetadataH\x00R\x0ftriggerMetadata\x12C\n" +
	"\rrule_metadata\x18\a \x01(\v2\x1c.metaxisdata.v1.RuleMetadataH\x00R\fruleMetadataB\n" +
	"\n" +
	"\bmetadata\"\xc8\x03\n" +
	"\x19MetadataHistoryChangeItem\x12@\n" +
	"\asection\x18\x01 \x01(\x0e2&.metaxisdata.v1.MetadataHistorySectionR\asection\x12F\n" +
	"\toperation\x18\x02 \x01(\x0e2(.metaxisdata.v1.MetadataHistoryOperationR\toperation\x12\x10\n" +
	"\x03key\x18\x03 \x01(\tR\x03key\x12!\n" +
	"\fdisplay_name\x18\x04 \x01(\tR\vdisplayName\x12\x18\n" +
	"\asummary\x18\x05 \x01(\tR\asummary\x12H\n" +
	"\rfield_changes\x18\x06 \x03(\v2#.metaxisdata.v1.MetadataFieldChangeR\ffieldChanges\x12D\n" +
	"\x06before\x18\a \x01(\v2,.metaxisdata.v1.MetadataHistoryChildSnapshotR\x06before\x12B\n" +
	"\x05after\x18\b \x01(\v2,.metaxisdata.v1.MetadataHistoryChildSnapshotR\x05after\"\xa3\x01\n" +
	"\x1aMetadataHistoryChangeGroup\x12@\n" +
	"\asection\x18\x01 \x01(\x0e2&.metaxisdata.v1.MetadataHistorySectionR\asection\x12C\n" +
	"\achanges\x18\x02 \x03(\v2).metaxisdata.v1.MetadataHistoryChangeItemR\achanges\"\xbb\x02\n" +
	"\x14MetadataHistoryEvent\x12B\n" +
	...
	"targetTime\"K\n" +
	"\x14DiffMetadataResponse\x12!\n" +
	"\fdiff_summary\x18\x01 \x01(\tR\vdiffSummary\x12\x10\n" +
	"\x03ddl\x18\x02 \x01(\tR\x03ddl\"\xa1\x04\n" +
	"\tManualSQL\x12\x12\n" +
	...
	"\x12procedure_metadata\x18\b \x01(\v2!.metaxisdata.v1.ProcedureMetadataH\x00R\x11procedureMetadata\x12O\n" +
	...
	" \x01(\tR\n" +
	"searchPath\x12K\n" +
	"\x0eevent_triggers\x18\v \x03(\v2$.metaxisdata.v1.EventTriggerMetadataR\reventTriggersJ\x04\b\a\x10\bJ\x04\b\b\x10\tR\fservice_nameR\x10linked_databases\"\xec\x05\n" +
	...
	"\tsequences\x18\n" +
	" \x03(\v2 .metaxisdata.v1.SequenceMetadataR\tsequences\x12\x14\n" +
	...
	"\tskip_dump\x18\x10 \x01(\bR\bskipDumpJ\x04\b\a\x10\bJ\x04\b\b\x10\tJ\x04\b\v\x10\fR\astreamsR\x05tasksR\bpackages\"u\n" +
	...
	"\bsql_mode\x18\a \x01(\tR\asqlMode\x12\x18\n" +
	"\acomment\x18\t \x01(\tR\acomment\x12\x1b\n" +
	"\tskip_dump\x18\b \x01(\bR\bskipDump\"\xcd\x04\n" +
	...
	"\x10opclass_defaults\x18\x11 \x03(\bR\x0fopclassDefaults\x12I\n" +
	"\x0espatial_config\x18\x0f \x01(\v2\".metaxisdata.v1.SpatialIndexConfigR\rspatialConfigJ\x04\b\r\x10\x0eR\vgranularity\"\x96\x03\n" +
	...
	"\n" +
	"match_type\x18\b \x01(\tR\tmatchType*\xbe\x01\n" +
	"\x18MetadataHistoryOperation\x12*\n" +
	"&METADATA_HISTORY_OPERATION_UNSPECIFIED\x10\x00\x12&\n" +
	"\"METADATA_HISTORY_OPERATION_CREATED\x10\x01\x12&\n" +
	"\"METADATA_HISTORY_OPERATION_UPDATED\x10\x02\x12&\n" +
	"\"METADATA_HISTORY_OPERATION_DELETED\x10\x03*\xc2\x03\n" +
	"\x16MetadataHistorySection\x12(\n" +
	"$METADATA_HISTORY_SECTION_UNSPECIFIED\x10\x00\x12!\n" +
	"\x1dMETADATA_HISTORY_SECTION_SELF\x10\x01\x12#\n" +
	"\x1fMETADATA_HISTORY_SECTION_COLUMN\x10\x02\x12\"\n" +
	"\x1eMETADATA_HISTORY_SECTION_INDEX\x10\x03\x12(\n" +
	"$METADATA_HISTORY_SECTION_FOREIGN_KEY\x10\x04\x12-\n" +
	")METADATA_HISTORY_SECTION_CHECK_CONSTRAINT\x10\x05\x12&\n" +
	"\"METADATA_HISTORY_SECTION_PARTITION\x10\x06\x12$\n" +
	" METADATA_HISTORY_SECTION_TRIGGER\x10\a\x12!\n" +
	...
	"\vOPENLINEAGE\x10d\"\x04\b\r\x10\r\"\x04\b\x0e\x10\x0e\"\x04\b\x0f\x10\x0f*\aPACKAGE*\x06STREAM*\x04TASK2\xfa\x14\n" +
	"\x0fDatabaseService\x12\xb6\x01\n" +
	"\fSyncDatabase\x12#.metaxisdata.v1.SyncDatabaseRequest\x1a$.metaxisdata.v1.SyncDatabaseResponse\"[\xdaA\x04name\x8a\xea0\x1ametaxisdata.databases.sync\x98\xea0\x01\x82\xd3\xe4\x93\x02,:\x01*\"'/v1/{name=instances/*/databases/*}:sync\x12\x91\x01\n" +
	"\rListDatabases\x12$.metaxisdata.v1.ListDatabasesRequest\x1a%.metaxisdata.v1.ListDatabasesResponse\"3\x8a\xea0\x1ametaxisdata.databases.list\x82\xd3\xe4\x93\x02\x0f\x12\r/v1/databases\x12\x8e\x01\n" +
	"\fListMetadata\x12#.metaxisdata.v1.ListMetadataRequest\x1a .metaxisdata.v1.MetadataResponse\"7\x8a\xea0\x1ametaxisdata.databases.read\x82\xd3\xe4\x93\x02\x13\x12\x11/v1/metadata/list\x12\x8a\x01\n" +
	"\vGetMetadata\x12\".metaxisdata.v1.GetMetadataRequest\x1a#.metaxisdata.v1.GetMetadataResponse\"2\x8a\xea0\x1ametaxisdata.databases.read\x82\xd3\xe4\x93\x02\x0e\x12\f/v1/metadata\x12\xaa\x01\n" +
	"\x13ListMetadataHistory\x12*.metaxisdata.v1.ListMetadataHistoryRequest\x1a+.metaxisdata.v1.ListMetadataHistoryResponse\":\x8a\xea0\x1ametaxisdata.databases.read\x82\xd3\xe4\x93\x02\x16\x12\x14/v1/metadata/history\x12\xb1\x01\n" +
	"\x17GetMetadataHistoryEvent\x12..metaxisdata.v1.GetMetadataHistoryEventRequest\x1a$.metaxisdata.v1.MetadataHistoryEvent\"@\x8a\xea0\x1ametaxisdata.databases.read\x82\xd3\xe4\x93\x02\x1c\x12\x1a/v1/metadata/history/event\x12\x9a\x01\n" +
	"\x0eSearchMetadata\x12%.metaxisdata.v1.SearchMetadataRequest\x1a&.metaxisdata.v1.SearchMetadataResponse\"9\x8a\xea0\x1ametaxisdata.databases.read\x82\xd3\xe4\x93\x02\x15\x12\x13/v1/metadata/search\x12\xa0\x01\n" +
	"\x0fGetSchemaString\x12&.metaxisdata.v1.GetSchemaStringRequest\x1a$.metaxisdata.v1.MetadataSchemaString\"?\x8a\xea0\x1ametaxisdata.databases.read\x82\xd3\xe4\x93\x02\x1b\x12\x19/v1/metadata/schemaString\x12\x92\x01\n" +
	"\fDiffMetadata\x12#.metaxisdata.v1.DiffMetadataRequest\x1a$.metaxisdata.v1.DiffMetadataResponse\"7\x8a\xea0\x1ametaxisdata.databases.read\x82\xd3\xe4\x93\x02\x13\x12\x11/v1/metadata/diff\x12\xe1\x01\n" +
	"\x0fCreateManualSQL\x12&.metaxisdata.v1.CreateManualSQLRequest\x1a\x19.metaxisdata.v1.ManualSQL\"\x8a\x01\xdaA\x1fparent,manual_sql,manual_sql_id\x8a\xea0\x1dmetaxisdata.manualSqls.create\x98\xea0\x01\x82\xd3\xe4\x93\x02=:\n" +
	"manual_sql\"//v1/{parent=instances/*/databases/*}/manualSqls\x12\xac\x01\n" +
	"\fGetManualSQL\x12#.metaxisdata.v1.GetManualSQLRequest\x1a\x19.metaxisdata.v1.ManualSQL\"\\\xdaA\x04name\x8a\xea0\x1ametaxisdata.manualSqls.get\x82\xd3\xe4\x93\x021\x12//v1/{name=instances/*/databases/*/manualSqls/*}\x12\xc0\x01\n" +
	"\x0eListManualSQLs\x12%.metaxisdata.v1.ListManualSQLsRequest\x1a&.metaxisdata.v1.ListManualSQLsResponse\"_\xdaA\x06parent\x8a\xea0\x1bmetaxisdata.manualSqls.list\x82\xd3\xe4\x93\x021\x12//v1/{parent=instances/*/databases/*}/manualSqls\x12\xd0\x01\n" +
	"\x0fSearchManualSQL\x12&.metaxisdata.v1.SearchManualSQLRequest\x1a'.metaxisdata.v1.SearchManualSQLResponse\"l\xdaA\fparent,query\x8a\xea0\x1bmetaxisdata.manualSqls.list\x82\xd3\xe4\x93\x028\x126/v1/{parent=instances/*/databases/*}/manualSqls:search\x12\xe3\x01\n" +
	"\x0fUpdateManualSQL\x12&.metaxisdata.v1.UpdateManualSQLRequest\x1a\x19.metaxisdata.v1.ManualSQL\"\x8c\x01\xdaA\x16manual_sql,update_mask\x8a\xea0\x1dmetaxisdata.manualSqls.update\x98\xea0\x01\x82\xd3\xe4\x93\x02H:\n" +
	"manual_sql2:/v1/{manual_sql.name=instances/*/databases/*/manualSqls/*}\x12\xb6\x01\n" +
	"\x0fDeleteManualSQL\x12&.metaxisdata.v1.DeleteManualSQLRequest\x1a\x16.google.protobuf.Empty\"c\xdaA\x04name\x8a\xea0\x1dmetaxisdata.manualSqls.delete\x98\xea0\x01\x82\xd3\xe4\x93\x021*//v1/{name=instances/*/databases/*/manualSqls/*}B6Z4github.com/Ranxy/metaxisdata/backend/generated-go/v1b\x06proto3"
...
var file_v1_database_service_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_v1_database_service_proto_msgTypes = make([]protoimpl.MessageInfo, 72)
var file_v1_database_service_proto_goTypes = []any{
	...
	(MetaType)(0),                             // 2: metaxisdata.v1.MetaType
	(TablePartitionMetadata_Type)(0),          // 3: metaxisdata.v1.TablePartitionMetadata.Type
	(ColumnMetadata_IdentityGeneration)(0),    // 4: metaxisdata.v1.ColumnMetadata.IdentityGeneration
	(GenerationMetadata_Type)(0),              // 5: metaxisdata.v1.GenerationMetadata.Type
	(*SyncDatabaseRequest)(nil),               // 6: metaxisdata.v1.SyncDatabaseRequest
	(*SyncDatabaseResponse)(nil),              // 7: metaxisdata.v1.SyncDatabaseResponse
	(*Database)(nil),                          // 8: metaxisdata.v1.Database
	(*ListDatabasesRequest)(nil),              // 9: metaxisdata.v1.ListDatabasesRequest
	(*ListDatabasesResponse)(nil),             // 10: metaxisdata.v1.ListDatabasesResponse
	(*ListMetadataRequest)(nil),               // 11: metaxisdata.v1.ListMetadataRequest
	(*MetadataResponse)(nil),                  // 12: metaxisdata.v1.MetadataResponse
	(*GetMetadataRequest)(nil),                // 13: metaxisdata.v1.GetMetadataRequest
	(*GetMetadataResponse)(nil),               // 14: metaxisdata.v1.GetMetadataResponse
	(*ListMetadataHistoryRequest)(nil),        // 15: metaxisdata.v1.ListMetadataHistoryRequest
	(*ListMetadataHistoryResponse)(nil),       // 16: metaxisdata.v1.ListMetadataHistoryResponse
	(*GetMetadataHistoryEventRequest)(nil),    // 17: metaxisdata.v1.GetMetadataHistoryEventRequest
	(*MetadataHistorySectionChangeCount)(nil), // 18: metaxisdata.v1.MetadataHistorySectionChangeCount
	(*MetadataHistoryTimelineEntry)(nil),      // 19: metaxisdata.v1.MetadataHistoryTimelineEntry
	(*MetadataFieldChange)(nil),               // 20: metaxisdata.v1.MetadataFieldChange
	(*MetadataHistoryChildSnapshot)(nil),      // 21: metaxisdata.v1.MetadataHistoryChildSnapshot
	(*MetadataHistoryChangeItem)(nil),         // 22: metaxisdata.v1.MetadataHistoryChangeItem
	(*MetadataHistoryChangeGroup)(nil),        // 23: metaxisdata.v1.MetadataHistoryChangeGroup
	(*MetadataHistoryEvent)(nil),              // 24: metaxisdata.v1.MetadataHistoryEvent
	(*GetSchemaStringRequest)(nil),            // 25: metaxisdata.v1.GetSchemaStringRequest
	(*MetadataSchemaString)(nil),              // 26: metaxisdata.v1.MetadataSchemaString
	(*SearchMetadataRequest)(nil),             // 27: metaxisdata.v1.SearchMetadataRequest
	(*SearchMetadataResponse)(nil),            // 28: metaxisdata.v1.SearchMetadataResponse
	(*SearchMetadataResult)(nil),              // 29: metaxisdata.v1.SearchMetadataResult
	(*DiffMetadataRequest)(nil),               // 30: metaxisdata.v1.DiffMetadataRequest
	(*DiffMetadataResponse)(nil),              // 31: metaxisdata.v1.DiffMetadataResponse
	(*ManualSQL)(nil),                         // 32: metaxisdata.v1.ManualSQL
	(*CreateManualSQLRequest)(nil),            // 33: metaxisdata.v1.CreateManualSQLRequest
	(*GetManualSQLRequest)(nil),               // 34: metaxisdata.v1.GetManualSQLRequest
	(*ListManualSQLsRequest)(nil),             // 35: metaxisdata.v1.ListManualSQLsRequest
	(*ListManualSQLsResponse)(nil),            // 36: metaxisdata.v1.ListManualSQLsResponse
	(*SearchManualSQLRequest)(nil),            // 37: metaxisdata.v1.SearchManualSQLRequest
	(*SearchManualSQLResponse)(nil),           // 38: metaxisdata.v1.SearchManualSQLResponse
	(*UpdateManualSQLRequest)(nil),            // 39: metaxisdata.v1.UpdateManualSQLRequest
	(*DeleteManualSQLRequest)(nil),            // 40: metaxisdata.v1.DeleteManualSQLRequest
	(*ManualSQLMetadata)(nil),                 // 41: metaxisdata.v1.ManualSQLMetadata
	(*StoredMetadata)(nil),                    // 42: metaxisdata.v1.StoredMetadata
	(*DatabaseSchemaMetadata)(nil),            // 43: metaxisdata.v1.DatabaseSchemaMetadata
	(*SchemaMetadata)(nil),                    // 44: metaxisdata.v1.SchemaMetadata
	(*EnumTypeMetadata)(nil),                  // 45: metaxisdata.v1.EnumTypeMetadata
	(*EventMetadata)(nil),                     // 46: metaxisdata.v1.EventMetadata
	(*SequenceMetadata)(nil),                  // 47: metaxisdata.v1.SequenceMetadata
	(*TriggerMetadata)(nil),                   // 48: metaxisdata.v1.TriggerMetadata
	(*RuleMetadata)(nil),                      // 49: metaxisdata.v1.RuleMetadata
	(*TableMetadata)(nil),                     // 50: metaxisdata.v1.TableMetadata
	(*CheckConstraintMetadata)(nil),           // 51: metaxisdata.v1.CheckConstraintMetadata
	(*ExcludeConstraintMetadata)(nil),         // 52: metaxisdata.v1.ExcludeConstraintMetadata
	(*ExternalTableMetadata)(nil),             // 53: metaxisdata.v1.ExternalTableMetadata
	(*TablePartitionMetadata)(nil),            // 54: metaxisdata.v1.TablePartitionMetadata
	(*ColumnMetadata)(nil),                    // 55: metaxisdata.v1.ColumnMetadata
	(*GenerationMetadata)(nil),                // 56: metaxisdata.v1.GenerationMetadata
	(*ViewMetadata)(nil),                      // 57: metaxisdata.v1.ViewMetadata
	(*DependencyColumn)(nil),                  // 58: metaxisdata.v1.DependencyColumn
	(*MaterializedViewMetadata)(nil),          // 59: metaxisdata.v1.MaterializedViewMetadata
	(*DependencyTable)(nil),                   // 60: metaxisdata.v1.DependencyTable
	(*FunctionMetadata)(nil),                  // 61: metaxisdata.v1.FunctionMetadata
	(*ProcedureMetadata)(nil),                 // 62: metaxisdata.v1.ProcedureMetadata
	(*IndexMetadata)(nil),                     // 63: metaxisdata.v1.IndexMetadata
	(*SpatialIndexConfig)(nil),                // 64: metaxisdata.v1.SpatialIndexConfig
	(*TessellationConfig)(nil),                // 65: metaxisdata.v1.TessellationConfig
	(*BoundingBox)(nil),                       // 66: metaxisdata.v1.BoundingBox
	(*GridLevel)(nil),                         // 67: metaxisdata.v1.GridLevel
	(*StorageConfig)(nil),                     // 68: metaxisdata.v1.StorageConfig
	(*DimensionalConfig)(nil),                 // 69: metaxisdata.v1.DimensionalConfig
	(*ExtensionMetadata)(nil),                 // 70: metaxisdata.v1.ExtensionMetadata
	(*EventTriggerMetadata)(nil),              // 71: metaxisdata.v1.EventTriggerMetadata
	(*ForeignKeyMetadata)(nil),                // 72: metaxisdata.v1.ForeignKeyMetadata
	nil,                                       // 73: metaxisdata.v1.Database.LabelsEntry
	(*MetadataResponse_Metadata)(nil),         // 74: metaxisdata.v1.MetadataResponse.Metadata
	nil,                                       // 75: metaxisdata.v1.ManualSQL.AttributesEntry
	nil,                                       // 76: metaxisdata.v1.ManualSQLMetadata.AttributesEntry
	nil,                                       // 77: metaxisdata.v1.SpatialIndexConfig.EngineSpecificEntry
	(State)(0),                                // 78: metaxisdata.v1.State
	(*timestamppb.Timestamp)(nil),             // 79: google.protobuf.Timestamp
	(*InstanceResource)(nil),                  // 80: metaxisdata.v1.InstanceResource
...
var file_v1_database_service_proto_depIdxs = []int32{
	78,  // 0: metaxisdata.v1.Database.state:type_name -> metaxisdata.v1.State
	79,  // 1: metaxisdata.v1.Database.successful_sync_time:type_name -> google.protobuf.Timestamp
	73,  // 2: metaxisdata.v1.Database.labels:type_name -> metaxisdata.v1.Database.LabelsEntry
	80,  // 3: metaxisdata.v1.Database.instance_resource:type_name -> metaxisdata.v1.InstanceResource
	8,   // 4: metaxisdata.v1.ListDatabasesResponse.databases:type_name -> metaxisdata.v1.Database
	2,   // 5: metaxisdata.v1.ListMetadataRequest.meta_type:type_name -> metaxisdata.v1.MetaType
	74,  // 6: metaxisdata.v1.MetadataResponse.types_stored_metadata:type_name -> metaxisdata.v1.MetadataResponse.Metadata
	2,   // 7: metaxisdata.v1.GetMetadataRequest.meta_type:type_name -> metaxisdata.v1.MetaType
	42,  // 8: metaxisdata.v1.GetMetadataResponse.metadata:type_name -> metaxisdata.v1.StoredMetadata
	2,   // 9: metaxisdata.v1.ListMetadataHistoryRequest.meta_type:type_name -> metaxisdata.v1.MetaType
	19,  // 10: metaxisdata.v1.ListMetadataHistoryResponse.entries:type_name -> metaxisdata.v1.MetadataHistoryTimelineEntry
	2,   // 11: metaxisdata.v1.GetMetadataHistoryEventRequest.meta_type:type_name -> metaxisdata.v1.MetaType
	79,  // 12: metaxisdata.v1.GetMetadataHistoryEventRequest.event_time:type_name -> google.protobuf.Timestamp
	...
	79,  // 16: metaxisdata.v1.MetadataHistoryTimelineEntry.event_time:type_name -> google.protobuf.Timestamp
	79,  // 17: metaxisdata.v1.MetadataHistoryTimelineEntry.valid_from:type_name -> google.protobuf.Timestamp
	79,  // 18: metaxisdata.v1.MetadataHistoryTimelineEntry.valid_to:type_name -> google.protobuf.Timestamp
	0,   // 19: metaxisdata.v1.MetadataHistoryTimelineEntry.operation:type_name -> metaxisdata.v1.MetadataHistoryOperation
	18,  // 20: metaxisdata.v1.MetadataHistoryTimelineEntry.section_changes:type_name -> metaxisdata.v1.MetadataHistorySectionChangeCount
	55,  // 21: metaxisdata.v1.MetadataHistoryChildSnapshot.column_metadata:type_name -> metaxisdata.v1.ColumnMetadata
	63,  // 22: metaxisdata.v1.MetadataHistoryChildSnapshot.index_metadata:type_name -> metaxisdata.v1.IndexMetadata
	72,  // 23: metaxisdata.v1.MetadataHistoryChildSnapshot.foreign_key_metadata:type_name -> metaxisdata.v1.ForeignKeyMetadata
	51,  // 24: metaxisdata.v1.MetadataHistoryChildSnapshot.check_constraint_metadata:type_name -> metaxisdata.v1.CheckConstraintMetadata
	54,  // 25: metaxisdata.v1.MetadataHistoryChildSnapshot.partition_metadata:type_name -> metaxisdata.v1.TablePartitionMetadata
	48,  // 26: metaxisdata.v1.MetadataHistoryChildSnapshot.trigger_metadata:type_name -> metaxisdata.v1.TriggerMetadata
	49,  // 27: metaxisdata.v1.MetadataHistoryChildSnapshot.rule_metadata:type_name -> metaxisdata.v1.RuleMetadata
	...
	20,  // 30: metaxisdata.v1.MetadataHistoryChangeItem.field_changes:type_name -> metaxisdata.v1.MetadataFieldChange
	21,  // 31: metaxisdata.v1.MetadataHistoryChangeItem.before:type_name -> metaxisdata.v1.MetadataHistoryChildSnapshot
	21,  // 32: metaxisdata.v1.MetadataHistoryChangeItem.after:type_name -> metaxisdata.v1.MetadataHistoryChildSnapshot
	1,   // 33: metaxisdata.v1.MetadataHistoryChangeGroup.section:type_name -> metaxisdata.v1.MetadataHistorySection
	22,  // 34: metaxisdata.v1.MetadataHistoryChangeGroup.changes:type_name -> metaxisdata.v1.MetadataHistoryChangeItem
	19,  // 35: metaxisdata.v1.MetadataHistoryEvent.entry:type_name -> metaxisdata.v1.MetadataHistoryTimelineEntry
	42,  // 36: metaxisdata.v1.MetadataHistoryEvent.before_metadata:type_name -> metaxisdata.v1.StoredMetadata
	42,  // 37: metaxisdata.v1.MetadataHistoryEvent.after_metadata:type_name -> metaxisdata.v1.StoredMetadata
	23,  // 38: metaxisdata.v1.MetadataHistoryEvent.change_groups:type_name -> metaxisdata.v1.MetadataHistoryChangeGroup
	...
	29,  // 41: metaxisdata.v1.SearchMetadataResponse.results:type_name -> metaxisdata.v1.SearchMetadataResult
	2,   // 42: metaxisdata.v1.SearchMetadataResult.meta_type:type_name -> metaxisdata.v1.MetaType
	42,  // 43: metaxisdata.v1.SearchMetadataResult.metadata:type_name -> metaxisdata.v1.StoredMetadata
	79,  // 44: metaxisdata.v1.DiffMetadataRequest.source_time:type_name -> google.protobuf.Timestamp
	79,  // 45: metaxisdata.v1.DiffMetadataRequest.target_time:type_name -> google.protobuf.Timestamp
	75,  // 46: metaxisdata.v1.ManualSQL.attributes:type_name -> metaxisdata.v1.ManualSQL.AttributesEntry
	79,  // 47: metaxisdata.v1.ManualSQL.created_at:type_name -> google.protobuf.Timestamp
	79,  // 48: metaxisdata.v1.ManualSQL.updated_at:type_name -> google.protobuf.Timestamp
	32,  // 49: metaxisdata.v1.CreateManualSQLRequest.manual_sql:type_name -> metaxisdata.v1.ManualSQL
	32,  // 50: metaxisdata.v1.ListManualSQLsResponse.manual_sqls:type_name -> metaxisdata.v1.ManualSQL
	32,  // 51: metaxisdata.v1.SearchManualSQLResponse.manual_sqls:type_name -> metaxisdata.v1.ManualSQL
	32,  // 52: metaxisdata.v1.UpdateManualSQLRequest.manual_sql:type_name -> metaxisdata.v1.ManualSQL
	81,  // 53: metaxisdata.v1.UpdateManualSQLRequest.update_mask:type_name -> google.protobuf.FieldMask
	76,  // 54: metaxisdata.v1.ManualSQLMetadata.attributes:type_name -> metaxisdata.v1.ManualSQLMetadata.AttributesEntry
	43,  // 55: metaxisdata.v1.StoredMetadata.database_schema_metadata:type_name -> metaxisdata.v1.DatabaseSchemaMetadata
	44,  // 56: metaxisdata.v1.StoredMetadata.schema_metadata:type_name -> metaxisdata.v1.SchemaMetadata
	50,  // 57: metaxisdata.v1.StoredMetadata.table_metadata:type_name -> metaxisdata.v1.TableMetadata
	53,  // 58: metaxisdata.v1.StoredMetadata.external_table_metadata:type_name -> metaxisdata.v1.ExternalTableMetadata
	57,  // 59: metaxisdata.v1.StoredMetadata.view_metadata:type_name -> metaxisdata.v1.ViewMetadata
	59,  // 60: metaxisdata.v1.StoredMetadata.materialized_view_metadata:type_name -> metaxisdata.v1.MaterializedViewMetadata
	61,  // 61: metaxisdata.v1.StoredMetadata.function_metadata:type_name -> metaxisdata.v1.FunctionMetadata
	62,  // 62: metaxisdata.v1.StoredMetadata.procedure_metadata:type_name -> metaxisdata.v1.ProcedureMetadata
	47,  // 63: metaxisdata.v1.StoredMetadata.sequence_metadata:type_name -> metaxisdata.v1.SequenceMetadata
	41,  // 64: metaxisdata.v1.StoredMetadata.manual_sql_metadata:type_name -> metaxisdata.v1.ManualSQLMetadata
	55,  // 65: metaxisdata.v1.StoredMetadata.column_metadata:type_name -> metaxisdata.v1.ColumnMetadata
	44,  // 66: metaxisdata.v1.DatabaseSchemaMetadata.schemas:type_name -> metaxisdata.v1.SchemaMetadata
	70,  // 67: metaxisdata.v1.DatabaseSchemaMetadata.extensions:type_name -> metaxisdata.v1.ExtensionMetadata
	71,  // 68: metaxisdata.v1.DatabaseSchemaMetadata.event_triggers:type_name -> metaxisdata.v1.EventTriggerMetadata
	50,  // 69: metaxisdata.v1.SchemaMetadata.tables:type_name -> metaxisdata.v1.TableMetadata
	53,  // 70: metaxisdata.v1.SchemaMetadata.external_tables:type_name -> metaxisdata.v1.ExternalTableMetadata
	57,  // 71: metaxisdata.v1.SchemaMetadata.views:type_name -> metaxisdata.v1.ViewMetadata
	61,  // 72: metaxisdata.v1.SchemaMetadata.functions:type_name -> metaxisdata.v1.FunctionMetadata
	62,  // 73: metaxisdata.v1.SchemaMetadata.procedures:type_name -> metaxisdata.v1.ProcedureMetadata
	59,  // 74: metaxisdata.v1.SchemaMetadata.materialized_views:type_name -> metaxisdata.v1.MaterializedViewMetadata
	47,  // 75: metaxisdata.v1.SchemaMetadata.sequences:type_name -> metaxisdata.v1.SequenceMetadata
	46,  // 76: metaxisdata.v1.SchemaMetadata.events:type_name -> metaxisdata.v1.EventMetadata
	45,  // 77: metaxisdata.v1.SchemaMetadata.enum_types:type_name -> metaxisdata.v1.EnumTypeMetadata
	55,  // 78: metaxisdata.v1.TableMetadata.columns:type_name -> metaxisdata.v1.ColumnMetadata
	63,  // 79: metaxisdata.v1.TableMetadata.indexes:type_name -> metaxisdata.v1.IndexMetadata
	72,  // 80: metaxisdata.v1.TableMetadata.foreign_keys:type_name -> metaxisdata.v1.ForeignKeyMetadata
	54,  // 81: metaxisdata.v1.TableMetadata.partitions:type_name -> metaxisdata.v1.TablePartitionMetadata
	51,  // 82: metaxisdata.v1.TableMetadata.check_constraints:type_name -> metaxisdata.v1.CheckConstraintMetadata
	48,  // 83: metaxisdata.v1.TableMetadata.triggers:type_name -> metaxisdata.v1.TriggerMetadata
	49,  // 84: metaxisdata.v1.TableMetadata.rules:type_name -> metaxisdata.v1.RuleMetadata
	52,  // 85: metaxisdata.v1.TableMetadata.exclude_constraints:type_name -> metaxisdata.v1.ExcludeConstraintMetadata
	55,  // 86: metaxisdata.v1.ExternalTableMetadata.columns:type_name -> metaxisdata.v1.ColumnMetadata
	3,   // 87: metaxisdata.v1.TablePartitionMetadata.type:type_name -> metaxisdata.v1.TablePartitionMetadata.Type
	54,  // 88: metaxisdata.v1.TablePartitionMetadata.subpartitions:type_name -> metaxisdata.v1.TablePartitionMetadata
	63,  // 89: metaxisdata.v1.TablePartitionMetadata.indexes:type_name -> metaxisdata.v1.IndexMetadata
	51,  // 90: metaxisdata.v1.TablePartitionMetadata.check_constraints:type_name -> metaxisdata.v1.CheckConstraintMetadata
	52,  // 91: metaxisdata.v1.TablePartitionMetadata.exclude_constraints:type_name -> metaxisdata.v1.ExcludeConstraintMetadata
	56,  // 92: metaxisdata.v1.ColumnMetadata.generation:type_name -> metaxisdata.v1.GenerationMetadata
	4,   // 93: metaxisdata.v1.ColumnMetadata.identity_generation:type_name -> metaxisdata.v1.ColumnMetadata.IdentityGeneration
	5,   // 94: metaxisdata.v1.GenerationMetadata.type:type_name -> metaxisdata.v1.GenerationMetadata.Type
	58,  // 95: metaxisdata.v1.ViewMetadata.dependency_columns:type_name -> metaxisdata.v1.DependencyColumn
	55,  // 96: metaxisdata.v1.ViewMetadata.columns:type_name -> metaxisdata.v1.ColumnMetadata
	...
	65,  // 104: metaxisdata.v1.SpatialIndexConfig.tessellation:type_name -> metaxisdata.v1.TessellationConfig
	68,  // 105: metaxisdata.v1.SpatialIndexConfig.storage:type_name -> metaxisdata.v1.StorageConfig
	69,  // 106: metaxisdata.v1.SpatialIndexConfig.dimensional:type_name -> metaxisdata.v1.DimensionalConfig
	77,  // 107: metaxisdata.v1.SpatialIndexConfig.engine_specific:type_name -> metaxisdata.v1.SpatialIndexConfig.EngineSpecificEntry
	66,  // 108: metaxisdata.v1.TessellationConfig.bounding_box:type_name -> metaxisdata.v1.BoundingBox
	67,  // 109: metaxisdata.v1.TessellationConfig.grid_levels:type_name -> metaxisdata.v1.GridLevel
	2,   // 110: metaxisdata.v1.MetadataResponse.Metadata.meta_type:type_name -> metaxisdata.v1.MetaType
	42,  // 111: metaxisdata.v1.MetadataResponse.Metadata.list:type_name -> metaxisdata.v1.StoredMetadata
	6,   // 112: metaxisdata.v1.DatabaseService.SyncDatabase:input_type -> metaxisdata.v1.SyncDatabaseRequest
	9,   // 113: metaxisdata.v1.DatabaseService.ListDatabases:input_type -> metaxisdata.v1.ListDatabasesRequest
	11,  // 114: metaxisdata.v1.DatabaseService.ListMetadata:input_type -> metaxisdata.v1.ListMetadataRequest
	13,  // 115: metaxisdata.v1.DatabaseService.GetMetadata:input_type -> metaxisdata.v1.GetMetadataRequest
	15,  // 116: metaxisdata.v1.DatabaseService.ListMetadataHistory:input_type -> metaxisdata.v1.ListMetadataHistoryRequest
	17,  // 117: metaxisdata.v1.DatabaseService.GetMetadataHistoryEvent:input_type -> metaxisdata.v1.GetMetadataHistoryEventRequest
	27,  // 118: metaxisdata.v1.DatabaseService.SearchMetadata:input_type -> metaxisdata.v1.SearchMetadataRequest
	25,  // 119: metaxisdata.v1.DatabaseService.GetSchemaString:input_type -> metaxisdata.v1.GetSchemaStringRequest
	30,  // 120: metaxisdata.v1.DatabaseService.DiffMetadata:input_type -> metaxisdata.v1.DiffMetadataRequest
	33,  // 121: metaxisdata.v1.DatabaseService.CreateManualSQL:input_type -> metaxisdata.v1.CreateManualSQLRequest
	34,  // 122: metaxisdata.v1.DatabaseService.GetManualSQL:input_type -> metaxisdata.v1.GetManualSQLRequest
	35,  // 123: metaxisdata.v1.DatabaseService.ListManualSQLs:input_type -> metaxisdata.v1.ListManualSQLsRequest
	37,  // 124: metaxisdata.v1.DatabaseService.SearchManualSQL:input_type -> metaxisdata.v1.SearchManualSQLRequest
	39,  // 125: metaxisdata.v1.DatabaseService.UpdateManualSQL:input_type -> metaxisdata.v1.UpdateManualSQLRequest
	40,  // 126: metaxisdata.v1.DatabaseService.DeleteManualSQL:input_type -> metaxisdata.v1.DeleteManualSQLRequest
	7,   // 127: metaxisdata.v1.DatabaseService.SyncDatabase:output_type -> metaxisdata.v1.SyncDatabaseResponse
	10,  // 128: metaxisdata.v1.DatabaseService.ListDatabases:output_type -> metaxisdata.v1.ListDatabasesResponse
	12,  // 129: metaxisdata.v1.DatabaseService.ListMetadata:output_type -> metaxisdata.v1.MetadataResponse
	14,  // 130: metaxisdata.v1.DatabaseService.GetMetadata:output_type -> metaxisdata.v1.GetMetadataResponse
	16,  // 131: metaxisdata.v1.DatabaseService.ListMetadataHistory:output_type -> metaxisdata.v1.ListMetadataHistoryResponse
	24,  // 132: metaxisdata.v1.DatabaseService.GetMetadataHistoryEvent:output_type -> metaxisdata.v1.MetadataHistoryEvent
	28,  // 133: metaxisdata.v1.DatabaseService.SearchMetadata:output_type -> metaxisdata.v1.SearchMetadataResponse
	26,  // 134: metaxisdata.v1.DatabaseService.GetSchemaString:output_type -> metaxisdata.v1.MetadataSchemaString
	31,  // 135: metaxisdata.v1.DatabaseService.DiffMetadata:output_type -> metaxisdata.v1.DiffMetadataResponse
	32,  // 136: metaxisdata.v1.DatabaseService.CreateManualSQL:output_type -> metaxisdata.v1.ManualSQL
	32,  // 137: metaxisdata.v1.DatabaseService.GetManualSQL:output_type -> metaxisdata.v1.ManualSQL
	36,  // 138: metaxisdata.v1.DatabaseService.ListManualSQLs:output_type -> metaxisdata.v1.ListManualSQLsResponse
	38,  // 139: metaxisdata.v1.DatabaseService.SearchManualSQL:output_type -> metaxisdata.v1.SearchManualSQLResponse
	32,  // 140: metaxisdata.v1.DatabaseService.UpdateManualSQL:output_type -> metaxisdata.v1.ManualSQL
	82,  // 141: metaxisdata.v1.DatabaseService.DeleteManualSQL:output_type -> google.protobuf.Empty
	127, // [127:142] is the sub-list for method output_type
	112, // [112:127] is the sub-list for method input_type
...
func file_v1_database_service_proto_init() {
	...
	file_v1_database_service_proto_msgTypes[15].OneofWrappers = []any{
		...
		(*MetadataHistoryChildSnapshot_CheckConstraintMetadata)(nil),
		(*MetadataHistoryChildSnapshot_PartitionMetadata)(nil),
