...
func (c *lineageServiceClient) GetLineageForContext(ctx context.Context, in *GetLineageForContextRequest, opts ...grpc.CallOption) (*GetLineageForContextResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetLineageForContextResponse)
	err := c.cc.Invoke(ctx, LineageService_GetLineageForContext_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterLineageServiceServer(s grpc.ServiceRegistrar, srv LineageServiceServer) {
	// If the following call panics, it indicates UnimplementedLineageServiceServer was
...
func _LineageService_GetLineageForContext_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLineageForContextRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LineageServiceServer).GetLineageForContext(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LineageService_GetLineageForContext_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LineageServiceServer).GetLineageForContext(ctx, req.(*GetLineageForContextRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LineageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "metaxisdata.v1.LineageService",
	...
	Metadata: "v1/lineage_service.proto",
}
