...
const (
	...
	GroupServiceName = "metaxisdata.v1.GroupService"
)
...
const (
	...
	GroupServiceGetGroupProcedure = "/metaxisdata.v1.GroupService/GetGroup"
	// GroupServiceListGroupsProcedure is the fully-qualified name of the GroupService's ListGroups RPC.
	GroupServiceListGroupsProcedure = "/metaxisdata.v1.GroupService/ListGroups"
	// GroupServiceCreateGroupProcedure is the fully-qualified name of the GroupService's CreateGroup
	// RPC.
	GroupServiceCreateGroupProcedure = "/metaxisdata.v1.GroupService/CreateGroup"
	// GroupServiceUpdateGroupProcedure is the fully-qualified name of the GroupService's UpdateGroup
	// RPC.
	GroupServiceUpdateGroupProcedure = "/metaxisdata.v1.GroupService/UpdateGroup"
	// GroupServiceDeleteGroupProcedure is the fully-qualified name of the GroupService's DeleteGroup
	// RPC.
	GroupServiceDeleteGroupProcedure = "/metaxisdata.v1.GroupService/DeleteGroup"
)

// GroupServiceClient is a client for the metaxisdata.v1.GroupService service.
...
// NewGroupServiceClient constructs a client for the metaxisdata.v1.GroupService service. By
...
// GetGroup calls metaxisdata.v1.GroupService.GetGroup.
...
// ListGroups calls metaxisdata.v1.GroupService.ListGroups.
...
// CreateGroup calls metaxisdata.v1.GroupService.CreateGroup.
...
// UpdateGroup calls metaxisdata.v1.GroupService.UpdateGroup.
...
// DeleteGroup calls metaxisdata.v1.GroupService.DeleteGroup.
...
// GroupServiceHandler is an implementation of the metaxisdata.v1.GroupService service.
...
func NewGroupServiceHandler(svc GroupServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/metaxisdata.v1.GroupService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGroupServiceHandler) GetGroup(context.Context, *connect.Request[v1.GetGroupRequest]) (*connect.Response[v1.Group], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.GroupService.GetGroup is not implemented"))
}
...
func (UnimplementedGroupServiceHandler) ListGroups(context.Context, *connect.Request[v1.ListGroupsRequest]) (*connect.Response[v1.ListGroupsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.GroupService.ListGroups is not implemented"))
}
...
func (UnimplementedGroupServiceHandler) CreateGroup(context.Context, *connect.Request[v1.CreateGroupRequest]) (*connect.Response[v1.Group], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.GroupService.CreateGroup is not implemented"))
}
...
func (UnimplementedGroupServiceHandler) UpdateGroup(context.Context, *connect.Request[v1.UpdateGroupRequest]) (*connect.Response[v1.Group], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.GroupService.UpdateGroup is not implemented"))
}
...
func (UnimplementedGroupServiceHandler) DeleteGroup(context.Context, *connect.Request[v1.DeleteGroupRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.GroupService.DeleteGroup is not implemented"))
}
