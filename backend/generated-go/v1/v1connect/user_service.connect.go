...
const (
	...
	UserServiceName = "metaxisdata.v1.UserService"
)
...
const (
	...
	UserServiceGetUserProcedure = "/metaxisdata.v1.UserService/GetUser"
	// UserServiceBatchGetUsersProcedure is the fully-qualified name of the UserService's BatchGetUsers
	// RPC.
	UserServiceBatchGetUsersProcedure = "/metaxisdata.v1.UserService/BatchGetUsers"
	// UserServiceGetCurrentUserProcedure is the fully-qualified name of the UserService's
	// GetCurrentUser RPC.
	UserServiceGetCurrentUserProcedure = "/metaxisdata.v1.UserService/GetCurrentUser"
	// UserServiceListUsersProcedure is the fully-qualified name of the UserService's ListUsers RPC.
	UserServiceListUsersProcedure = "/metaxisdata.v1.UserService/ListUsers"
	// UserServiceCreateUserProcedure is the fully-qualified name of the UserService's CreateUser RPC.
	UserServiceCreateUserProcedure = "/metaxisdata.v1.UserService/CreateUser"
	// UserServiceUpdateUserProcedure is the fully-qualified name of the UserService's UpdateUser RPC.
	UserServiceUpdateUserProcedure = "/metaxisdata.v1.UserService/UpdateUser"
	// UserServiceDeleteUserProcedure is the fully-qualified name of the UserService's DeleteUser RPC.
	UserServiceDeleteUserProcedure = "/metaxisdata.v1.UserService/DeleteUser"
	// UserServiceUndeleteUserProcedure is the fully-qualified name of the UserService's UndeleteUser
	// RPC.
	UserServiceUndeleteUserProcedure = "/metaxisdata.v1.UserService/UndeleteUser"
)
...
// NewUserServiceClient constructs a client for the metaxisdata.v1.UserService service. By default,
...
// GetUser calls metaxisdata.v1.UserService.GetUser.
...
// BatchGetUsers calls metaxisdata.v1.UserService.BatchGetUsers.
...
// GetCurrentUser calls metaxisdata.v1.UserService.GetCurrentUser.
...
// ListUsers calls metaxisdata.v1.UserService.ListUsers.
...
// CreateUser calls metaxisdata.v1.UserService.CreateUser.
...
// UpdateUser calls metaxisdata.v1.UserService.UpdateUser.
...
// DeleteUser calls metaxisdata.v1.UserService.DeleteUser.
...
// UndeleteUser calls metaxisdata.v1.UserService.UndeleteUser.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/metaxisdata.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.User], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) BatchGetUsers(context.Context, *connect.Request[v1.BatchGetUsersRequest]) (*connect.Response[v1.BatchGetUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.UserService.BatchGetUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetCurrentUser(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[v1.User], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.UserService.GetCurrentUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListUsers(context.Context, *connect.Request[v1.ListUsersRequest]) (*connect.Response[v1.ListUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.UserService.ListUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.User], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.UserService.CreateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.User], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.UserService.UpdateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect.Request[v1.DeleteUserRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.UserService.DeleteUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UndeleteUser(context.Context, *connect.Request[v1.UndeleteUserRequest]) (*connect.Response[v1.User], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.UserService.UndeleteUser is not implemented"))
}
