...
const (
	...
	InstanceServiceName = "metaxisdata.v1.InstanceService"
)
...
const (
	...
	// GetInstance RPC.
	InstanceServiceGetInstanceProcedure = "/metaxisdata.v1.InstanceService/GetInstance"
	// InstanceServiceListInstancesProcedure is the fully-qualified name of the InstanceService's
	// ListInstances RPC.
	InstanceServiceListInstancesProcedure = "/metaxisdata.v1.InstanceService/ListInstances"
	// InstanceServiceCreateInstanceProcedure is the fully-qualified name of the InstanceService's
	// CreateInstance RPC.
	InstanceServiceCreateInstanceProcedure = "/metaxisdata.v1.InstanceService/CreateInstance"
	// InstanceServiceUpdateInstanceProcedure is the fully-qualified name of the InstanceService's
	// UpdateInstance RPC.
	InstanceServiceUpdateInstanceProcedure = "/metaxisdata.v1.InstanceService/UpdateInstance"
	// InstanceServiceDeleteInstanceProcedure is the fully-qualified name of the InstanceService's
	// DeleteInstance RPC.
	InstanceServiceDeleteInstanceProcedure = "/metaxisdata.v1.InstanceService/DeleteInstance"
	// InstanceServiceUndeleteInstanceProcedure is the fully-qualified name of the InstanceService's
	// UndeleteInstance RPC.
	InstanceServiceUndeleteInstanceProcedure = "/metaxisdata.v1.InstanceService/UndeleteInstance"
...
// ListInstances calls metaxisdata.v1.InstanceService.ListInstances.
...
// CreateInstance calls metaxisdata.v1.InstanceService.CreateInstance.
...
// UpdateInstance calls metaxisdata.v1.InstanceService.UpdateInstance.
...
// DeleteInstance calls metaxisdata.v1.InstanceService.DeleteInstance.
...
// UndeleteInstance calls metaxisdata.v1.InstanceService.UndeleteInstance.
...
// SyncInstance calls metaxisdata.v1.InstanceService.SyncInstance.
...
// BatchUpdateInstances calls metaxisdata.v1.InstanceService.BatchUpdateInstances.
...
func (UnimplementedInstanceServiceHandler) GetInstance(context.Context, *connect.Request[v1.GetInstanceRequest]) (*connect.Response[v1.Instance], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.InstanceService.GetInstance is not implemented"))
}
...
func (UnimplementedInstanceServiceHandler) ListInstances(context.Context, *connect.Request[v1.ListInstancesRequest]) (*connect.Response[v1.ListInstancesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.InstanceService.ListInstances is not implemented"))
}
...
func (UnimplementedInstanceServiceHandler) CreateInstance(context.Context, *connect.Request[v1.CreateInstanceRequest]) (*connect.Response[v1.Instance], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.InstanceService.CreateInstance is not implemented"))
}
...
func (UnimplementedInstanceServiceHandler) UpdateInstance(context.Context, *connect.Request[v1.UpdateInstanceRequest]) (*connect.Response[v1.Instance], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.InstanceService.UpdateInstance is not implemented"))
}
...
func (UnimplementedInstanceServiceHandler) DeleteInstance(context.Context, *connect.Request[v1.DeleteInstanceRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.InstanceService.DeleteInstance is not implemented"))
}
...
func (UnimplementedInstanceServiceHandler) UndeleteInstance(context.Context, *connect.Request[v1.UndeleteInstanceRequest]) (*connect.Response[v1.Instance], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.InstanceService.UndeleteInstance is not implemented"))
}
...
func (UnimplementedInstanceServiceHandler) BatchSyncInstances(context.Context, *connect.Request[v1.BatchSyncInstancesRequest]) (*connect.Response[v1.BatchSyncInstancesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.InstanceService.BatchSyncInstances is not implemented"))
}
