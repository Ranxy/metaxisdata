...
const (
	...
	AuditLogServiceName = "metaxisdata.v1.AuditLogService"
)
...
const (
	...
	// ListAuditLogs RPC.
	AuditLogServiceListAuditLogsProcedure = "/metaxisdata.v1.AuditLogService/ListAuditLogs"
)

// AuditLogServiceClient is a client for the metaxisdata.v1.AuditLogService service.
...
// NewAuditLogServiceClient constructs a client for the metaxisdata.v1.AuditLogService service. By
...
// ListAuditLogs calls metaxisdata.v1.AuditLogService.ListAuditLogs.
...
// AuditLogServiceHandler is an implementation of the metaxisdata.v1.AuditLogService service.
...
func NewAuditLogServiceHandler(svc AuditLogServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/metaxisdata.v1.AuditLogService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuditLogServiceHandler) ListAuditLogs(context.Context, *connect.Request[v1.ListAuditLogsRequest]) (*connect.Response[v1.ListAuditLogsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metaxisdata.v1.AuditLogService.ListAuditLogs is not implemented"))
}
