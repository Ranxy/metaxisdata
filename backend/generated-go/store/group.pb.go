...
type GroupMember struct {
	...
	Role          GroupMember_Role `protobuf:"varint,2,opt,name=role,proto3,enum=metaxisdata.store.GroupMember_Role" json:"role,omitempty"`
...
const file_store_group_proto_rawDesc = "" +
	"\n" +
	"\x11store/group.proto\x12\x11metaxisdata.store\"\x93\x01\n" +
	"\vGroupMember\x12\x16\n" +
	"\x06member\x18\x01 \x01(\tR\x06member\x127\n" +
	"\x04role\x18\x02 \x01(\x0e2#.metaxisdata.store.GroupMember.RoleR\x04role\"3\n" +
	"\x04Role\x12\x14\n" +
...
var file_store_group_proto_goTypes = []any{
	(GroupMember_Role)(0), // 0: metaxisdata.store.GroupMember.Role
	(*GroupMember)(nil),   // 1: metaxisdata.store.GroupMember
	(*GroupPayload)(nil),  // 2: metaxisdata.store.GroupPayload
}
var file_store_group_proto_depIdxs = []int32{
	0, // 0: metaxisdata.store.GroupMember.role:type_name -> metaxisdata.store.GroupMember.Role
	1, // 1: metaxisdata.store.GroupPayload.members:type_name -> metaxisdata.store.GroupMember
