...
type TablePartitionMetadata struct {
	...
	Type TablePartitionMetadata_Type `protobuf:"varint,2,opt,name=type,proto3,enum=metaxisdata.store.TablePartitionMetadata_Type" json:"type,omitempty"`
...
type ColumnMetadata struct {
	...
	IdentityGeneration ColumnMetadata_IdentityGeneration `protobuf:"varint,15,opt,name=identity_generation,json=identityGeneration,proto3,enum=metaxisdata.store.ColumnMetadata_IdentityGeneration" json:"identity_generation,omitempty"`
...
type GenerationMetadata struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	Type          GenerationMetadata_Type `protobuf:"varint,1,opt,name=type,proto3,enum=metaxisdata.store.GenerationMetadata_Type" json:"type,omitempty"`
	Expression    string                  `protobuf:"bytes,2,opt,name=expression,proto3" json:"expression,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_store_database_proto_rawDesc = "" +
	"\n" +
	"\x14store/database.proto\x12\x11metaxisdata.store\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17store/openlineage.proto\"\xc2\x02\n" +
	"\x10DatabaseMetadata\x12G\n" +
	"\x06labels\x18\x01 \x03(\v2/.metaxisdata.store.DatabaseMetadata.LabelsEntryR\x06labels\x12@\n" +
	"\x0elast_sync_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\flastSyncTime\x12\x1c\n" +
	...
	"\tcollation\x18\x04 \x01(\tR\tcollation\x12D\n" +
	"\n" +
	...
	"\x0fexternal_tables\x18\x03 \x03(\v2(.metaxisdata.store.ExternalTableMetadataR\x0eexternalTables\x125\n" +
	"\x05views\x18\x04 \x03(\v2\x1f.metaxisdata.store.ViewMetadataR\x05views\x12A\n" +
	"\tfunctions\x18\x05 \x03(\v2#.metaxisdata.store.FunctionMetadataR\tfunctions\x12D\n" +
	"\n" +
	"procedures\x18\x06 \x03(\v2$.metaxisdata.store.ProcedureMetadataR\n" +
	"procedures\x12Z\n" +
	"\x12materialized_views\x18\t \x03(\v2+.metaxisdata.store.MaterializedViewMetadataR\x11materializedViews\x12A\n" +
	"\tsequences\x18\n" +
	" \x03(\v2#.metaxisdata.store.SequenceMetadataR\tsequences\x12\x14\n" +
	"\x05owner\x18\f \x01(\tR\x05owner\x12\x18\n" +
	"\acomment\x18\r \x01(\tR\acomment\x128\n" +
	"\x06events\x18\x0e \x03(\v2 .metaxisdata.store.EventMetadataR\x06events\x12B\n" +
	"\n" +
	"enum_types\x18\x0f \x03(\v2#.metaxisdata.store.EnumTypeMetadataR\tenumTypes\x12\x1b\n" +
	...
	"\x04name\x18\x01 \x01(\tR\x04name\x12;\n" +
	"\acolumns\x18\x02 \x03(\v2!.metaxisdata.store.ColumnMetadataR\acolumns\x12:\n" +
	"\aindexes\x18\x03 \x03(\v2 .metaxisdata.store.IndexMetadataR\aindexes\x12\x16\n" +
	...
	"\fuser_comment\x18\x0e \x01(\tR\vuserComment\x12H\n" +
	"\fforeign_keys\x18\f \x03(\v2%.metaxisdata.store.ForeignKeyMetadataR\vforeignKeys\x12I\n" +
	"\n" +
	"partitions\x18\x0f \x03(\v2).metaxisdata.store.TablePartitionMetadataR\n" +
	"partitions\x12W\n" +
	"\x11check_constraints\x18\x10 \x03(\v2*.metaxisdata.store.CheckConstraintMetadataR\x10checkConstraints\x12\x14\n" +
	"\x05owner\x18\x12 \x01(\tR\x05owner\x12!\n" +
	"\fsorting_keys\x18\x13 \x03(\tR\vsortingKeys\x12>\n" +
	"\btriggers\x18\x14 \x03(\v2\".metaxisdata.store.TriggerMetadataR\btriggers\x12\x1b\n" +
	"\tskip_dump\x18\x15 \x01(\bR\bskipDump\x125\n" +
	"\x05rules\x18\x18 \x03(\v2\x1f.metaxisdata.store.RuleMetadataR\x05rules\x12#\n" +
	"\rsharding_info\x18\x16 \x01(\tR\fshardingInfo\x12(\n" +
	"\x10primary_key_type\x18\x17 \x01(\tR\x0eprimaryKeyType\x12]\n" +
	"\x13exclude_constraints\x18\x19 \x03(\v2,.metaxisdata.store.ExcludeConstraintMetadataR\x12excludeConstraints\"M\n" +
	...
	"\x16external_database_name\x18\x03 \x01(\tR\x14externalDatabaseName\x12;\n" +
	"\acolumns\x18\x04 \x03(\v2!.metaxisdata.store.ColumnMetadataR\acolumns\"\x99\x05\n" +
	"\x16TablePartitionMetadata\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12B\n" +
	"\x04type\x18\x02 \x01(\x0e2..metaxisdata.store.TablePartitionMetadata.TypeR\x04type\x12\x1e\n" +
	"\n" +
	...
	"useDefault\x12O\n" +
	"\rsubpartitions\x18\x06 \x03(\v2).metaxisdata.store.TablePartitionMetadataR\rsubpartitions\x12:\n" +
	"\aindexes\x18\a \x03(\v2 .metaxisdata.store.IndexMetadataR\aindexes\x12W\n" +
	"\x11check_constraints\x18\b \x03(\v2*.metaxisdata.store.CheckConstraintMetadataR\x10checkConstraints\x12]\n" +
	"\x13exclude_constraints\x18\t \x03(\v2,.metaxisdata.store.ExcludeConstraintMetadataR\x12excludeConstraints\"\x8a\x01\n" +
	"\x04Type\x12\x14\n" +
	...
	"\acomment\x18\n" +
	" \x01(\tR\acomment\x12!\n" +
	"\fuser_comment\x18\f \x01(\tR\vuserComment\x12E\n" +
	"\n" +
	"generation\x18\x0e \x01(\v2%.metaxisdata.store.GenerationMetadataR\n" +
	"generation\x12\x1f\n" +
	"\vis_identity\x18\x11 \x01(\bR\n" +
	"isIdentity\x12e\n" +
	"\x13identity_generation\x18\x0f \x01(\x0e24.metaxisdata.store.ColumnMetadata.IdentityGenerationR\x12identityGeneration\x12#\n" +
	...
	"\n" +
	"BY_DEFAULT\x10\x02\"\xb5\x01\n" +
	"\x12GenerationMetadata\x12>\n" +
	"\x04type\x18\x01 \x01(\x0e2*.metaxisdata.store.GenerationMetadata.TypeR\x04type\x12\x1e\n" +
	"\n" +
	"expression\x18\x02 \x01(\tR\n" +
	"expression\"?\n" +
	"\x04Type\x12\x14\n" +
	...
	"\btriggers\x18\x06 \x03(\v2\".metaxisdata.store.TriggerMetadataR\btriggers\x12\x1b\n" +
	"\tskip_dump\x18\a \x01(\bR\bskipDump\x125\n" +
	"\x05rules\x18\b \x03(\v2\x1f.metaxisdata.store.RuleMetadataR\x05rules\"X\n" +
	...
	"\x06schema\x18\x01 \x01(\tR\x06schema\x12\x14\n" +
	"\x05table\x18\x02 \x01(\tR\x05table\"\x9b\x03\n" +
	...
	"\acomment\x18\b \x01(\tR\acomment\x12O\n" +
	"\x11dependency_tables\x18\t \x03(\v2\".metaxisdata.store.DependencyTableR\x10dependencyTables\x12\x1b\n" +
	"\tskip_dump\x18\n" +
	...
	"\bsql_mode\x18\a \x01(\tR\asqlMode\x12\x18\n" +
	"\acomment\x18\t \x01(\tR\acomment\x12\x1b\n" +
	"\tskip_dump\x18\b \x01(\bR\bskipDump\"\xd0\x04\n" +
	...
	"\x10opclass_defaults\x18\x11 \x03(\bR\x0fopclassDefaults\x12L\n" +
	"\x0espatial_config\x18\x0f \x01(\v2%.metaxisdata.store.SpatialIndexConfigR\rspatialConfigJ\x04\b\r\x10\x0eR\vgranularity\"\xa2\x03\n" +
	"\x12SpatialIndexConfig\x12\x16\n" +
	"\x06method\x18\x01 \x01(\tR\x06method\x12I\n" +
	"\ftessellation\x18\x02 \x01(\v2%.metaxisdata.store.TessellationConfigR\ftessellation\x12:\n" +
	"\astorage\x18\x03 \x01(\v2 .metaxisdata.store.StorageConfigR\astorage\x12F\n" +
	"\vdimensional\x18\x04 \x01(\v2$.metaxisdata.store.DimensionalConfigR\vdimensional\x12b\n" +
	"\x0fengine_specific\x18\x05 \x03(\v29.metaxisdata.store.SpatialIndexConfig.EngineSpecificEntryR\x0eengineSpecific\x1aA\n" +
	"\x13EngineSpecificEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xd8\x01\n" +
	"\x12TessellationConfig\x12\x16\n" +
	"\x06scheme\x18\x01 \x01(\tR\x06scheme\x12A\n" +
	"\fbounding_box\x18\x02 \x01(\v2\x1e.metaxisdata.store.BoundingBoxR\vboundingBox\x12=\n" +
	"\vgrid_levels\x18\x03 \x03(\v2\x1c.metaxisdata.store.GridLevelR\n" +
	"gridLevels\x12(\n" +
	...
	"\n" +
	"match_type\x18\b \x01(\tR\tmatchType\"\xb2\x03\n" +
	...
	"\x0etable_metadata\x18\x03 \x01(\v2 .metaxisdata.store.TableMetadataH\x00R\rtableMetadata\x12b\n" +
	"\x17external_table_metadata\x18\x04 \x01(\v2(.metaxisdata.store.ExternalTableMetadataH\x00R\x15externalTableMetadata\x12F\n" +
	"\rview_metadata\x18\x05 \x01(\v2\x1f.metaxisdata.store.ViewMetadataH\x00R\fviewMetadata\x12k\n" +
	"\x1amaterialized_view_metadata\x18\x06 \x01(\v2+.metaxisdata.store.MaterializedViewMetadataH\x00R\x18materializedViewMetadata\x12R\n" +
	"\x11function_metadata\x18\a \x01(\v2#.metaxisdata.store.FunctionMetadataH\x00R\x10functionMetadata\x12U\n" +
	"\x12procedure_metadata\x18\b \x01(\v2$.metaxisdata.store.ProcedureMetadataH\x00R\x11procedureMetadata\x12R\n" +
	"\x11sequence_metadata\x18\n" +
	" \x01(\v2#.metaxisdata.store.SequenceMetadataH\x00R\x10sequenceMetadata\x12b\n" +
	...
	"\x04typeJ\x04\b\t\x10\n" +
	"J\x04\b\v\x10\fJ\x04\b\f\x10\rR\x10package_metadataR\x0fstream_metadataR\rtask_metadataB\x14Z\x12generated-go/storeb\x06proto3"
...
var file_store_database_proto_goTypes = []any{
	(TablePartitionMetadata_Type)(0),       // 0: metaxisdata.store.TablePartitionMetadata.Type
	(ColumnMetadata_IdentityGeneration)(0), // 1: metaxisdata.store.ColumnMetadata.IdentityGeneration
	(GenerationMetadata_Type)(0),           // 2: metaxisdata.store.GenerationMetadata.Type
	(*DatabaseMetadata)(nil),               // 3: metaxisdata.store.DatabaseMetadata
	(*DatabaseSchemaMetadata)(nil),         // 4: metaxisdata.store.DatabaseSchemaMetadata
	(*SchemaMetadata)(nil),                 // 5: metaxisdata.store.SchemaMetadata
	(*EnumTypeMetadata)(nil),               // 6: metaxisdata.store.EnumTypeMetadata
	(*EventMetadata)(nil),                  // 7: metaxisdata.store.EventMetadata
	(*SequenceMetadata)(nil),               // 8: metaxisdata.store.SequenceMetadata
	(*TriggerMetadata)(nil),                // 9: metaxisdata.store.TriggerMetadata
	(*RuleMetadata)(nil),                   // 10: metaxisdata.store.RuleMetadata
	(*TableMetadata)(nil),                  // 11: metaxisdata.store.TableMetadata
	(*CheckConstraintMetadata)(nil),        // 12: metaxisdata.store.CheckConstraintMetadata
	(*ExcludeConstraintMetadata)(nil),      // 13: metaxisdata.store.ExcludeConstraintMetadata
	(*ExternalTableMetadata)(nil),          // 14: metaxisdata.store.ExternalTableMetadata
	(*TablePartitionMetadata)(nil),         // 15: metaxisdata.store.TablePartitionMetadata
	(*ColumnMetadata)(nil),                 // 16: metaxisdata.store.ColumnMetadata
	(*GenerationMetadata)(nil),             // 17: metaxisdata.store.GenerationMetadata
	(*ViewMetadata)(nil),                   // 18: metaxisdata.store.ViewMetadata
	(*DependencyColumn)(nil),               // 19: metaxisdata.store.DependencyColumn
	(*MaterializedViewMetadata)(nil),       // 20: metaxisdata.store.MaterializedViewMetadata
	(*DependencyTable)(nil),                // 21: metaxisdata.store.DependencyTable
	(*FunctionMetadata)(nil),               // 22: metaxisdata.store.FunctionMetadata
	(*ProcedureMetadata)(nil),              // 23: metaxisdata.store.ProcedureMetadata
	(*IndexMetadata)(nil),                  // 24: metaxisdata.store.IndexMetadata
	(*SpatialIndexConfig)(nil),             // 25: metaxisdata.store.SpatialIndexConfig
	(*TessellationConfig)(nil),             // 26: metaxisdata.store.TessellationConfig
	(*BoundingBox)(nil),                    // 27: metaxisdata.store.BoundingBox
	(*GridLevel)(nil),                      // 28: metaxisdata.store.GridLevel
	(*StorageConfig)(nil),                  // 29: metaxisdata.store.StorageConfig
	(*DimensionalConfig)(nil),              // 30: metaxisdata.store.DimensionalConfig
	(*ExtensionMetadata)(nil),              // 31: metaxisdata.store.ExtensionMetadata
	(*EventTriggerMetadata)(nil),           // 32: metaxisdata.store.EventTriggerMetadata
	(*ForeignKeyMetadata)(nil),             // 33: metaxisdata.store.ForeignKeyMetadata
	(*ManualSQLMetadata)(nil),              // 34: metaxisdata.store.ManualSQLMetadata
	(*StoredMetadata)(nil),                 // 35: metaxisdata.store.StoredMetadata
	nil,                                    // 36: metaxisdata.store.DatabaseMetadata.LabelsEntry
	nil,                                    // 37: metaxisdata.store.SpatialIndexConfig.EngineSpecificEntry
	nil,                                    // 38: metaxisdata.store.ManualSQLMetadata.AttributesEntry
	(*timestamppb.Timestamp)(nil),          // 39: google.protobuf.Timestamp
	(*OpenLineageRunSummary)(nil),          // 40: metaxisdata.store.OpenLineageRunSummary
	(*OpenLineageTaskSummary)(nil),         // 41: metaxisdata.store.OpenLineageTaskSummary
}
var file_store_database_proto_depIdxs = []int32{
	36, // 0: metaxisdata.store.DatabaseMetadata.labels:type_name -> metaxisdata.store.DatabaseMetadata.LabelsEntry
	39, // 1: metaxisdata.store.DatabaseMetadata.last_sync_time:type_name -> google.protobuf.Timestamp
	5,  // 2: metaxisdata.store.DatabaseSchemaMetadata.schemas:type_name -> metaxisdata.store.SchemaMetadata
	31, // 3: metaxisdata.store.DatabaseSchemaMetadata.extensions:type_name -> metaxisdata.store.ExtensionMetadata
	32, // 4: metaxisdata.store.DatabaseSchemaMetadata.event_triggers:type_name -> metaxisdata.store.EventTriggerMetadata
	11, // 5: metaxisdata.store.SchemaMetadata.tables:type_name -> metaxisdata.store.TableMetadata
	14, // 6: metaxisdata.store.SchemaMetadata.external_tables:type_name -> metaxisdata.store.ExternalTableMetadata
	18, // 7: metaxisdata.store.SchemaMetadata.views:type_name -> metaxisdata.store.ViewMetadata
	22, // 8: metaxisdata.store.SchemaMetadata.functions:type_name -> metaxisdata.store.FunctionMetadata
	23, // 9: metaxisdata.store.SchemaMetadata.procedures:type_name -> metaxisdata.store.ProcedureMetadata
	20, // 10: metaxisdata.store.SchemaMetadata.materialized_views:type_name -> metaxisdata.store.MaterializedViewMetadata
	8,  // 11: metaxisdata.store.SchemaMetadata.sequences:type_name -> metaxisdata.store.SequenceMetadata
	7,  // 12: metaxisdata.store.SchemaMetadata.events:type_name -> metaxisdata.store.EventMetadata
	6,  // 13: metaxisdata.store.SchemaMetadata.enum_types:type_name -> metaxisdata.store.EnumTypeMetadata
	16, // 14: metaxisdata.store.TableMetadata.columns:type_name -> metaxisdata.store.ColumnMetadata
	24, // 15: metaxisdata.store.TableMetadata.indexes:type_name -> metaxisdata.store.IndexMetadata
	33, // 16: metaxisdata.store.TableMetadata.foreign_keys:type_name -> metaxisdata.store.ForeignKeyMetadata
	15, // 17: metaxisdata.store.TableMetadata.partitions:type_name -> metaxisdata.store.TablePartitionMetadata
	12, // 18: metaxisdata.store.TableMetadata.check_constraints:type_name -> metaxisdata.store.CheckConstraintMetadata
	9,  // 19: metaxisdata.store.TableMetadata.triggers:type_name -> metaxisdata.store.TriggerMetadata
	10, // 20: metaxisdata.store.TableMetadata.rules:type_name -> metaxisdata.store.RuleMetadata
	13, // 21: metaxisdata.store.TableMetadata.exclude_constraints:type_name -> metaxisdata.store.ExcludeConstraintMetadata
	16, // 22: metaxisdata.store.ExternalTableMetadata.columns:type_name -> metaxisdata.store.ColumnMetadata
	0,  // 23: metaxisdata.store.TablePartitionMetadata.type:type_name -> metaxisdata.store.TablePartitionMetadata.Type
	15, // 24: metaxisdata.store.TablePartitionMetadata.subpartitions:type_name -> metaxisdata.store.TablePartitionMetadata
	24, // 25: metaxisdata.store.TablePartitionMetadata.indexes:type_name -> metaxisdata.store.IndexMetadata
	12, // 26: metaxisdata.store.TablePartitionMetadata.check_constraints:type_name -> metaxisdata.store.CheckConstraintMetadata
	13, // 27: metaxisdata.store.TablePartitionMetadata.exclude_constraints:type_name -> metaxisdata.store.ExcludeConstraintMetadata
	17, // 28: metaxisdata.store.ColumnMetadata.generation:type_name -> metaxisdata.store.GenerationMetadata
	1,  // 29: metaxisdata.store.ColumnMetadata.identity_generation:type_name -> metaxisdata.store.ColumnMetadata.IdentityGeneration
	2,  // 30: metaxisdata.store.GenerationMetadata.type:type_name -> metaxisdata.store.GenerationMetadata.Type
	19, // 31: metaxisdata.store.ViewMetadata.dependency_columns:type_name -> metaxisdata.store.DependencyColumn
	16, // 32: metaxisdata.store.ViewMetadata.columns:type_name -> metaxisdata.store.ColumnMetadata
	...
	26, // 40: metaxisdata.store.SpatialIndexConfig.tessellation:type_name -> metaxisdata.store.TessellationConfig
	29, // 41: metaxisdata.store.SpatialIndexConfig.storage:type_name -> metaxisdata.store.StorageConfig
	30, // 42: metaxisdata.store.SpatialIndexConfig.dimensional:type_name -> metaxisdata.store.DimensionalConfig
	37, // 43: metaxisdata.store.SpatialIndexConfig.engine_specific:type_name -> metaxisdata.store.SpatialIndexConfig.EngineSpecificEntry
	27, // 44: metaxisdata.store.TessellationConfig.bounding_box:type_name -> metaxisdata.store.BoundingBox
	28, // 45: metaxisdata.store.TessellationConfig.grid_levels:type_name -> metaxisdata.store.GridLevel
	38, // 46: metaxisdata.store.ManualSQLMetadata.attributes:type_name -> metaxisdata.store.ManualSQLMetadata.AttributesEntry
	4,  // 47: metaxisdata.store.StoredMetadata.database_schema_metadata:type_name -> metaxisdata.store.DatabaseSchemaMetadata
	5,  // 48: metaxisdata.store.StoredMetadata.schema_metadata:type_name -> metaxisdata.store.SchemaMetadata
	11, // 49: metaxisdata.store.StoredMetadata.table_metadata:type_name -> metaxisdata.store.TableMetadata
	14, // 50: metaxisdata.store.StoredMetadata.external_table_metadata:type_name -> metaxisdata.store.ExternalTableMetadata
	18, // 51: metaxisdata.store.StoredMetadata.view_metadata:type_name -> metaxisdata.store.ViewMetadata
	20, // 52: metaxisdata.store.StoredMetadata.materialized_view_metadata:type_name -> metaxisdata.store.MaterializedViewMetadata
	22, // 53: metaxisdata.store.StoredMetadata.function_metadata:type_name -> metaxisdata.store.FunctionMetadata
	23, // 54: metaxisdata.store.StoredMetadata.procedure_metadata:type_name -> metaxisdata.store.ProcedureMetadata
	8,  // 55: metaxisdata.store.StoredMetadata.sequence_metadata:type_name -> metaxisdata.store.SequenceMetadata
	40, // 56: metaxisdata.store.StoredMetadata.openlineage_run_summary:type_name -> metaxisdata.store.OpenLineageRunSummary
	41, // 57: metaxisdata.store.StoredMetadata.openlineage_task_summary:type_name -> metaxisdata.store.OpenLineageTaskSummary
	34, // 58: metaxisdata.store.StoredMetadata.manual_sql_metadata:type_name -> metaxisdata.store.ManualSQLMetadata
	16, // 59: metaxisdata.store.StoredMetadata.column_metadata:type_name -> metaxisdata.store.ColumnMetadata
