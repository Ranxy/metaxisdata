...
func (s *Store) CreateProjectV2(ctx context.Context, create *ProjectMessage, _ int) (*ProjectMessage, error) {
...
func (*Store) listProjectImplV2(ctx context.Context, txn *sql.Tx, find *FindProjectMessage) ([]*ProjectMessage, error) {
